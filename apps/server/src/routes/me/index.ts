...
/**
 * `me` routes, mounted under /api/v1 by app.ts: GET/PATCH /me (profile)
 * and GET/PATCH /me/prefs (preference axes). All of them require a live
 * session and a configured meta store.
 */
