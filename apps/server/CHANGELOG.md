...
- Updated dependencies [4d26196]
  ...
  - @adminium/adapter-sqlite@0.3.4
  - @adminium/adapter-postgres@0.3.4
  - @adminium/meta@0.3.4
  - @adminium/i18n@0.3.4
  - @adminium/manifest@0.3.4
  - @adminium/adapter-mysql@0.3.4
  - @adminium/llm@0.3.4
  - @adminium/schema-import@0.3.4
...
- 325350b: The add-ons bundled with Adminium are now 1.0.5: on an Arabic printed copy an amount reads as it is written.
...
- 4448b09: **0.3.0 — add-ons own pages, and 0.2.10 through 0.2.12 are withdrawn.**
...
- 64a1f12: **Fixed: times on a venue-local column no longer shift by the server's time zone.**
...
- 5b4dbff: **Two people saving the same thing at once no longer see "Something went wrong".**
...
- dd63dc2: A page tells you when its table cannot back it, and offers the fix.
...
- ae8b1ed: An operator names each hosted app from Adminium, and dates stop defaulting to UTC.
