 ...
 * (its own chrome, and it rejects the classes the comp needs).
 *
...
export function Swatch({ on, hex, onClick, testId = 'report-swatch' }: { on: boolean; hex: string; onClick: () => void; testId?: string | undefined }) {
  return (
    <button
      type="button"
      title={hex}
...
export function Toggle({ on, onClick, labelledBy, testId = 'report-toggle' }: { on: boolean; onClick: () => void; labelledBy: string; testId?: string | undefined }) {
  return (
    <button
      type="button"
      role="switch"
...
export function RowRemoveButton({ label, onClick, className, iconClassName, testId = 'report-row-remove' }: { label: string; onClick: () => void; className?: string | undefined; iconClassName?: string | undefined; testId?: string | undefined }) {
  return (
    <button
      type="button"
      aria-label={label}
