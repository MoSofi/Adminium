...
/**
 * Saved views on page-crud: saving the current grid captures the live toolbar
 * state, and applying a saved view round-trips that state back into the CrudApi
 * query params (search / sort / filters / page size).
 */
