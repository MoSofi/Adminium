...
/**
 * Saved-views query + mutations for one page-crud page. Kept separate from the
 * switcher UI so the binding can auto-apply a default view on load and the
 * switcher stays presentational.
 */
