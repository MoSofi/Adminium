...
/**
 * The `onboarding` message namespace is DEFERRED (45-T08;
 * `DEFERRED_NAMESPACES`): 107 messages, 2.5 KiB gzipped, for the one screen an
 * instance shows once in its life — four times the entry ratchet's remaining
 * headroom if they had gone into `common` with the other `setup.*` keys.
 *
