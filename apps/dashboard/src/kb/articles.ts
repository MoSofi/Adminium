...
const RAW: unknown = [
  ...
  },
  {
    id: 'create-dialog',
    category: 'start',
    titleKey: 'kb.article.createDialog.title',
    titleFallback: 'The New and Edit dialogs',
    excerptKey: 'kb.article.createDialog.excerpt',
    excerptFallback: 'Where every field comes from, and how to design your own instead of the generated one.',
    docsPath: 'guides/forms',
  },
  {
    id: 'line-items',
    category: 'start',
    titleKey: 'kb.article.lineItems.title',
    titleFallback: 'Line items and bookings',
    excerptKey: 'kb.article.lineItems.excerpt',
    excerptFallback:
      'Tables of child rows with live totals, calendars bound to what is already booked, and one record per chip.',
    docsPath: 'guides/forms/line-items-and-dates',
  },
  {
    id: 'table-filters',
    category: 'start',
    titleKey: 'kb.article.tableFilters.title',
    titleFallback: 'Filtering a table',
    excerptKey: 'kb.article.tableFilters.excerpt',
    excerptFallback: 'The six kinds of filter, the two a page gets on its own, and how they ride into a saved view.',
    docsPath: 'guides/pages/filters',
  },
  {
    id: 'column-rules',
    category: 'connect',
    titleKey: 'kb.article.columnRules.title',
    titleFallback: 'Rules on a column',
    excerptKey: 'kb.article.columnRules.excerpt',
    excerptFallback: 'What fills a column, what it accepts and what its limits are — on every write, not just one form.',
    docsPath: 'guides/schema/column-rules',
  },
  {
    id: 'connect-db',
    category: 'connect',
  ...
  },
  {
    id: 'public-api',
    category: 'api',
    titleKey: 'kb.article.publicApi.title',
    titleFallback: 'Endpoints and keys for your pages',
    excerptKey: 'kb.article.publicApi.excerpt',
    excerptFallback: 'Let a page or another server call the tables you choose, with keys scoped to endpoints and methods.',
    docsPath: 'guides/public-api/endpoints-and-keys',
  },
  {
    id: 'api-docs-page',
    category: 'api',
    titleKey: 'kb.article.apiDocsPage.title',
    titleFallback: 'The API documentation page',
    excerptKey: 'kb.article.apiDocsPage.excerpt',
    excerptFallback: 'Publish /api-docs so the people who call your API can browse it and try a request.',
    docsPath: 'guides/public-api/api-docs-page',
  },
  {
    id: 'manifest',
    category: 'api',
