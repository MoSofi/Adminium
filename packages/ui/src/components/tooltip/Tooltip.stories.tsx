 ...
 * stories. The tooltip surface is the inverted `--fg`/`--bg` pair, so it
 * flips correctly in dark mode by itself. Matrix renders open by default so
 * VRT can screenshot without interaction.
 */
