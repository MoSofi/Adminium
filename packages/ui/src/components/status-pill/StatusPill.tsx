...
// The status→tone registry lives in lib/tones.ts — ONE registry instance
// package-wide, so a `registerStatusTones` caller and every consumer
// resolve through the same map. Re-exported here because this module was
// the barrel's historical source.
 ...
 * registry (research/design-system.md Tier 1).
 */
