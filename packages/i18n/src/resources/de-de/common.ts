...
export default {
  ...
  "kb": {
    ...
    "article": {
      ...
      "columnRules": {
        "title": "Regeln für eine Spalte",
        "excerpt": "Was eine Spalte füllt, was sie akzeptiert und welche Grenzen gelten — bei jedem Schreibvorgang, nicht nur in einem Formular."
      },
      "connectDb": {
      ...
      "createDialog": {
        "title": "Die Dialoge „Neu“ und „Bearbeiten“",
        "excerpt": "Woher jedes Feld kommt und wie Sie statt des generierten Formulars ein eigenes entwerfen."
      },
      "docker": {
      ...
      "lineItems": {
        "title": "Positionen und Buchungen",
        "excerpt": "Tabellen mit Unterzeilen und laufenden Summen, Kalender, die bereits Gebuchtes kennen, und ein Datensatz je Chip."
      },
      "manifest": {
      ...
      "tableFilters": {
        "title": "Eine Tabelle filtern",
        "excerpt": "Die sechs Filterarten, die zwei, die eine Seite von selbst erhält, und ihr Platz in einer gespeicherten Ansicht."
      },
      "telemetry": {
