  ...
  "remap": {
    ...
    "rules": {
      ...
      "decided": {
        ...
        "states": "Ändert sich nur durch die Schritte, die seine Regeln erlauben",
        "statesLock": "die Zeile ist gesperrt, solange sie {states} ist"
      },
      ...
      "shape": {
        "setBy": "Festgelegt von {addOn}",
        "confirmTitle": "Eine von {addOn} festgelegte Regel ausschalten?",
        "numbers": "Nummern können sich wiederholen oder fehlen.",
        "totals": "Summen sind dann, was eingetippt wird.",
        "edits": "Versendete Rechnungen können geändert werden.",
        "kept": "{addOn} füllt dies nicht mehr aus.",
