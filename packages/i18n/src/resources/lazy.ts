...
const LOADERS: Readonly<Record<string, () => Promise<BundleModule>>> = {
  ...
  'en-US/apiDocs': () => import('./en-us/apiDocs.js'),
  'en-US/roles': () => import('./en-us/roles.js'),
  ...
  'de-DE/apiDocs': () => import('./de-de/apiDocs.js'),
  'de-DE/roles': () => import('./de-de/roles.js'),
  ...
  'fr-FR/apiDocs': () => import('./fr-fr/apiDocs.js'),
  'fr-FR/roles': () => import('./fr-fr/roles.js'),
  ...
  'cs-CZ/apiDocs': () => import('./cs-cz/apiDocs.js'),
  'cs-CZ/roles': () => import('./cs-cz/roles.js'),
  ...
  'da-DK/apiDocs': () => import('./da-dk/apiDocs.js'),
  'da-DK/roles': () => import('./da-dk/roles.js'),
  ...
  'zh-CN/apiDocs': () => import('./zh-cn/apiDocs.js'),
  'zh-CN/roles': () => import('./zh-cn/roles.js'),
  ...
  'zh-TW/apiDocs': () => import('./zh-tw/apiDocs.js'),
  'zh-TW/roles': () => import('./zh-tw/roles.js'),
  ...
  'ar-EG/apiDocs': () => import('./ar-eg/apiDocs.js'),
  'ar-EG/roles': () => import('./ar-eg/roles.js'),
