...
export default {
  ...
  "formDialog": {
    "calendar": {
      ...
      "times": "المواعيد",
      "unchecked": "هذا الشهر به حجوزات أكثر من أن يتم التحقق منها هنا."
    },
    "control": {
      "fewer": "واحد أقل",
      "hide": "إخفاء",
    ...
    "footnote": {
      "required": "الحقول المطلوبة معلّمة بـ *"
    },
    "issue": {
      "required": "هذا الحقل مطلوب.",
      "notAllowed": "اختر إحدى القيم المتاحة.",
      "invalid": "هذه القيمة غير صالحة هنا.",
      "invalidCharacter": "يحتوي هذا النص على حرف مخفي لا يمكن حفظه. اكتبه مرة أخرى.",
      "email": "أدخل عنوان بريد إلكتروني صالحًا.",
      "url": "أدخل عنوان ويب صالحًا.",
      "phone": "أدخل رقم هاتف صالحًا.",
      "number": "أدخل رقمًا.",
      "integer": "أدخل عددًا صحيحًا.",
      "tooShort": "استخدم {n} حرفًا على الأقل.",
      "tooLong": "استخدم {n} حرفًا على الأكثر.",
      "tooSmall": "يجب أن تكون {min} أو أكثر.",
      "tooLarge": "يجب أن تكون {max} أو أقل.",
      "outOfRange": "هذا الرقم خارج النطاق.",
      "duplicate": "تمت إضافته بالفعل.",
      "form": "تم رفض بعض القيم. راجع الحقول المحددة."
    },
    "lines": {
      "add": "إضافة سطر",
      "remove": "إزالة السطر {n}"
    },
    "quick": {
      "today": "اليوم",
      "tomorrow": "غدًا",
    ...
    "reference": {
      "noAccess": "لا يمكنك قراءة {table}، لذا لا يمكن تغيير هذا الحقل هنا."
    },
    "subtitle": {
      "sections": "تفاصيل: {list}"
    },
    "title": {
      "create": "{entity} جديد",
      "edit": "تعديل {entity}"
    ...
    "unavailable": "لا يمكن عرض هذا الحقل: لا شيء يربط هذا السجل بالصفوف التي يشير إليها."
  },
  "combobox": {
    "placeholder": "اختر…",
    "search": "بحث…",
  ...
  "templates": {
    "crud": {
      ...
      "emptyTitleNamed": "لا توجد {things} بعد",
      "exportAction": "تصدير",
      "file": {
      ...
      "toast": {
        ...
        "createdMany": "{count, plural, zero {لم يتم إنشاء سجلات.} one {تم إنشاء سجل واحد.} two {تم إنشاء سجلين.} few {تم إنشاء # سجلات.} many {تم إنشاء # سجلًا.} other {تم إنشاء # سجل.}}",
        "deleteFailed": "فشل الحذف.",
        "deleted": "تم حذف {name}.",
        "exportIncomplete": "تم تصدير {written, number} من أصل {selected, number} صفًا محددًا — أعد التحميل وحاول مرة أخرى.",
      ...
      "linkFilter": {
        ...
        "now": "الآن",
        "daysAgo": "{count, plural, zero {اليوم − # يوم} one {اليوم − يوم واحد} two {اليوم − يومان} few {اليوم − # أيام} many {اليوم − # يومًا} other {اليوم − # يوم}}",
        "daysAhead": "{count, plural, zero {اليوم + # يوم} one {اليوم + يوم واحد} two {اليوم + يومان} few {اليوم + # أيام} many {اليوم + # يومًا} other {اليوم + # يوم}}"
      }
    },
    "queue": {
      "allSegment": "الكل",
    ...
    "dashboard": {
      ...
      "day": {
        ...
        "week": "هذا الأسبوع",
        "pick": "اختر يومًا",
        "pickHelp": "يوم واحد في كل مرة، بتوقيت المكان.",
        "cancel": "إلغاء",
        "show": "عرض اليوم"
      }
    },
    ...
    "board": {
      "invalidLayout": "التخطيط المخزَّن لهذه اللوحة غير صالح. أعد توليد الصفحة أو أعد تعيين تخطيطها.",
      "noRowsTitle": "لا توجد بطاقات بعد",
      "noRowsBody": "تظهر البطاقات هنا بمجرد أن يحتوي الجدول على صفوف."
    },
    "calendar": {
      ...
      "composeChoose": "ما يخص هذا الحدث",
      "composeChoosePlaceholder": "اختر…"
    },
    "scheduler": {
    ...
    "planning": {
      "unplaced": {
        "calendar": "لا يحتوي أي صف في هذا الجدول على تاريخ بعد، لذلك التقويم فارغ. يظهر الصف هنا بمجرد أن يكون له تاريخ.",
        "board": "لا يحتوي أي صف في هذا الجدول على حالة بعد، لذلك اللوحة فارغة. يظهر الصف هنا بمجرد أن تكون له حالة.",
        "scheduler": "لا يحتوي أي صف في هذا الجدول على شخص وتاريخ ونوع مناوبة بعد، لذلك الجدول الزمني فارغ. يظهر الصف هنا بمجرد أن تكتمل الثلاثة."
      }
    }
  },
  "frame": {
  ...
  "documents": {
    "panel": {
      "title": "المستندات",
      "empty": "لم يُرسم أي مستند لهذا السجل بعد.",
      "unnumbered": "بلا رقم",
      "voided": "ملغى",
      "failed": "تعذّر رسمه",
      "redacted": "ليس من حقك قراءة هذا",
      "download": "تنزيل",
      "print": "طباعة"
    },
    "make": {
