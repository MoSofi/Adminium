...
export default {
  ...
  "connect": {
    ...
    "dsn": {
      "checking": "جارٍ فحص قاعدة البيانات هذه…",
    ...
    "existing": {
      "adopt": "استخدمها وسجّل الدخول",
      "adopting": "جارٍ توجيه هذه النسخة إليها…",
      "body": "تحتوي على {count, plural, zero {أي جدول Adminium} one {جدول Adminium واحد} two {جدولي Adminium} few {# جداول Adminium} many {# جدول Adminium} other {# جدول Adminium}} فيها بيانات. أمامك خياران:",
      "failed": "تعذّر توجيه هذه النسخة إلى قاعدة البيانات تلك.",
      "otherSecret": "أُعدّت بـ ADMINIUM_SECRET مختلف: تسجيل الدخول هناك سيعمل، لكن هذه النسخة لا تستطيع فك تشفير نصوص الاتصال المحفوظة فيها.",
      "park": "أبقِها وابدأ من جديد",
      "parked": {
        "body": "تُعاد تسميتها وتُنحّى جانبًا — كل صف يبقى — ويبدأ Adminium بجداول جديدة بجوارها. لا يحدث شيء حتى تضع بيانات Adminium الخاصة في قاعدة البيانات هذه.",
        "title": "الجداول الموجودة سيتم الاحتفاظ بها"
      },
      "restarting": "جارٍ إعادة التشغيل عليها…",
      "timeout": "وُجِّه Adminium إلى قاعدة البيانات تلك لكنه لم يعد بعد — أعد تحميل هذه الصفحة بعد لحظات.",
      "title": "قاعدة البيانات تلك تشغّل Adminium بالفعل"
    },
  ...
  "meta": {
    ...
    "sameDb": {
      "alreadyAdminium": "قاعدة البيانات تلك تحتوي بالفعل على نسخة Adminium. ارجع خطوة للخلف للإبقاء على جداولها والبدء بجوارها، أو سجّل الدخول إليها بدلًا من ذلك.",
      ...
      "parked": "جداول Adminium الموجودة هناك يُعاد تسميتها وتُنحّى جانبًا أولًا — كل صف يبقى — ويبدأ Adminium بجداول جديدة بجوارها.",
