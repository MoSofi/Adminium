...
export default {
  ...
  "formDialog": {
    ...
    "issue": {
      ...
      "number": "請輸入數字。",
      "integer": "請輸入整數。",
      "tooShort": "請至少輸入 {n} 個字元。",
      "tooLong": "最多輸入 {n} 個字元。",
      "tooSmall": "必須大於或等於 {min}。",
      "tooLarge": "必須小於或等於 {max}。",
      "outOfRange": "此數字超出範圍。",
      "duplicate": "已新增。",
      "form": "部分值遭到拒絕。請檢查標記的欄位。"
    },
    "lines": {
      "add": "新增列",
      "remove": "移除第 {n} 列"
    ...
    "reference": {
      "noAccess": "你無權讀取 {table}，因此無法在此處修改。"
    },
    "subtitle": {
      "sections": "{list}資訊"
    },
  ...
  "templates": {
    "crud": {
      ...
      "emptyTitleNamed": "還沒有{things}",
      "exportAction": "匯出",
      "file": {
        "tooLarge": "該檔案超過 {limit} 的上限。",
        "uploading": "正在上傳",
        "cancel": "取消上傳",
        "replace": "取代",
        "remove": "移除檔案",
        ...
        "add": "新增檔案",
        "removeNamed": "移除 {name}",
        "capReached": "此記錄最多接受 {count, plural, other {# 個檔案}}。"
      },
      "filters": {
        "chip": "{name}：{values}",
        "custom": "自訂",
      ...
      "toast": {
        ...
        "createFailed": "建立失敗。",
        "created": "已建立 {entity}。",
        "createdMany": "{count, plural, other {已建立 # 筆記錄。}}",
        "deleteFailed": "刪除失敗。",
        "deleted": "已刪除 {name}。",
      ...
      "linkFilter": {
        ...
        "lte": "{name} 不超過 {value}",
        "after": "{name} 晚於 {value}",
        "before": "{name} 早於 {value}",
        "onOrAfter": "{name} 在 {value} 當天或之後",
        "onOrBefore": "{name} 在 {value} 當天或之前",
        "thisMonth": "{name} 在本月",
        "lastMonth": "{name} 在上月",
        "set": "{name} 已填寫",
        "unset": "{name} 為空",
    ...
    "record": {
      ...
      "attachments": {
        "emptyTitle": "尚無檔案",
        "emptyBody": "附加到此記錄的檔案會顯示在這裡。",
        "loading": "正在載入附件",
        "removed": "{name} 已移至回收桶。",
        "tooLarge": "該檔案超過此工作區允許的大小。"
      }
    },
    "pageRecord": {
