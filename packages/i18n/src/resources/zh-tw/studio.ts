...
/**
 * GENERATED MIRROR of ../../../locales/zh-TW/studio.json — do not edit by hand.
...
export default {
  "addOns": {
    ...
    "installed": {
      ...
      "missing": "遺失",
      "missingBody": "它的檔案不在此伺服器上，因此其中任何部分都不會載入。請重新安裝，或將其移除。",
  ...
  "documents": {
    ...
    "deleteConfirm": {
      "title": "刪除此對應？",
      "body": "觸發它的規則也會一併刪除，已據此產生的文件將失去回連結。此操作無法復原。",
      "prompt": "輸入 {name} 以確認",
      "confirm": "刪除對應"
    },
    "deleteFailed": "未刪除該對應",
  ...
  "enrich": {
    ...
    "noTablesBody": "此資料庫尚無任何資料表，因此 AI 沒有可標註或分組的內容。請繼續——資料表建立後，您可以隨時在「設定 → AI」中執行 AI 增強。",
    "noTablesTitle": "沒有可增強的資料表",
    "generatePrompt": "生成提示",
    "intentLabel": "你希望如何豐富？",
    "localeLocked": "（必填）",
    ...
    "provider": {
      "configError": "無法載入供應商設定——請在「設定 → AI」中設定一個，然後回到此步驟。",
      "description": "立即使用已設定的供應商執行豐富。你將以差異形式審閱每則建議。",
      "networkDisabled": "此 Adminium 無對外網路存取，無法連線服務商 API。請改用複製貼上往返方式——同樣的提示詞，同樣的審閱。",
      "readyBody": "在上方選擇「使用我的 AI 供應商」，立即對此連線執行豐富。",
      "readyTitle": "AI 供應商已設定",
      "setUpHere": "在此設定供應商",
      "setUpHide": "隱藏供應商設定",
      "settingsHint": "想直接執行嗎？",
      "settingsLink": "在「設定 → AI」中設定供應商",
      "title": "使用我的 AI 供應商",
      "unconfigured": "尚未設定 AI 供應商——請在下方設定一個，或將提示複製到你自己的 AI 工具。"
    },
  ...
  "hostedApps": {
    ...
    "install": {
      ...
      "bundle": {
        "title": "上傳應用程式安裝包",
        "hint": "應用程式的發布檔（.tgz）——其中含有 manifest.json 以及 staff/ 或 customer/ 目錄。",
        "file": "安裝包檔案（.tgz）",
        "fileHint": "在你於結構計畫這一步確認之前，不會建立任何東西。",
        "integrity": "完整性校驗（選填）",
        "integrityHint": "貼上隨版本發布的 sha512- 值，伺服器會據此檢查這些位元組。留空則在本頁計算。"
      },
      "database": {
        "title": "要安裝到哪個資料庫？",
        "hint": "選擇一個可寫入的連線。資料表會建立在那裡，應用程式之後也從那裡讀取。",
        "tables": "資料表：{count}",
        "readOnly": "唯讀",
        "writable": "可寫入",
        "noWritable": "沒有可寫入的連線",
        "allReadOnly": "這裡所有連線都使用唯讀角色，因此任何應用程式都無法建立自己的資料表。請先連接一個可以執行 DDL 的連線。"
      },
      "plan": {
        "title": "檢視結構計畫",
        "hint": "這正是將在你的資料庫中建立的內容。目前尚未寫入任何資料。",
        "refused": "這個應用程式無法安裝到這裡",
        "create": "建立",
        "reuse": "沿用現有",
        "toggleDdl": "顯示 DDL 預覽",
        "ddl": "DDL 預覽",
        ...
        "installedElsewhere": "{app} 已安裝在連線 {connection} 上。一個應用程式只在一個連線上執行：請在那裡更新它，或先在那裡解除安裝，再安裝到其他連線。"
      },
      "done": {
    ...
    "update": {
      ...
      "accessSubtitle": "檢查此版本讓應用程式的客戶可以做什麼。",
    ...
    "columns": {
      "title": "將 {app} 更新到 v{version}",
      "subtitle": "此版本需要資料庫中某些資料表尚未包含的欄位。",
      "body": "Adminium 可以為您新增這些欄位。執行任何操作前您都會看到確切的陳述式，不會刪除任何內容，且只有在欄位建立後才會更新應用程式。",
      "alsoCreates": "此更新也會建立以下資料表：",
      "noDdl": "Adminium 無法在此新增這些欄位",
      "failed": "無法新增這些欄位",
  ...
  "llmRuns": {
    "review": {
      ...
      "applyFailed": "沒有任何變更被套用",
      "applyUnknown": "伺服器沒有說明原因。",
      "bulk": {
        "acceptAll": "接受所有 ≥ {pct}%",
        "clear": "清除選取",
  ...
  "pages": {
    ...
    "field": {
      ...
      "table": "資料表",
      "tableChoose": "選擇資料表…",
      "tableCreateHint": "此頁面讀取的資料表。",
      "tableNeedsConnection": "請先選擇資料來源。",
      "tableNoConnection": "請先連接資料庫，此頁面由其中一個資料表建構。",
      "tableNone": "未繫結",
      "template": "範本",
    ...
    "fit": {
      "alternatives": {
        "title": "使用一個已經適用的資料表",
        "help": "不會寫入任何內容到你的資料庫——只是讓頁面指向一個已具備所需內容的資料表。",
        "use": "使用此資料表"
      },
      "checkFailed": "Adminium 無法檢查此資料表",
      "checkFailedBody": "你仍然可以建立該頁面。如果資料表不適用，建立時會告知你。",
      "columns": {
        "title": "為此資料表補上缺少的內容",
        "help": "Adminium 會向你的資料表新增這些欄位。在執行之前你會看到確切的語句，而且不會刪除任何內容。",
        "review": "查看變更",
        "confirm": "執行",
        "failed": "操作未成功",
        "partial": "此頁面所需的其中一項無法為你新增，因此之後仍會不完整。",
        "cannot": "這一項 Adminium 無法為你新增",
        "cannotBody": "此頁面需要指向另一個資料表的關聯，需要在 Studio → 結構 中設定。",
        "halfDone": "欄位已新增，但 Adminium 無法記錄它們的含意",
        "halfDoneBody": "無需重新執行——這些欄位已存在。請在 Studio → 結構 中設定它們的含意，或請管理員代為設定。"
      },
      "needs": "要建立此頁面，資料表還需要：",
      "noDdl": "Adminium 無法為你修改此資料表",
      "role": {
        "eventDate": "每一列一個日期",
        "title": "一個做為每列標題的文字欄",
        "status": "一個狀態欄，其值代表工作流程階段",
        "personFk": "指向人員資料表的關聯",
        "shiftType": "一個說明每列屬於哪種班別的欄位"
      },
      "slotOnly": "此資料表中沒有內容可以填入「{slot}」區域。",
      "tag": {
        "title": "使用你已有的欄位",
        "help": "這只會記錄該欄位的含意。你的資料庫不會被更動，並且可以在 Studio → 結構 中還原。",
        "action": "使用此欄位",
        "failed": "無法標記該欄位"
      },
      "title": "此資料表尚無法支撐這個頁面",
      "table": {
        "title": "為此頁面新建一個資料表",
        "help": "Adminium 會建立一個包含此頁面所需全部內容的資料表。執行任何操作前，您都會看到確切的陳述式，且不會變動您的其他資料表。",
        "open": "或為此頁面新建一個資料表",
        "name": "資料表名稱",
        "nameTaken": "已有同名的資料表。",
        "nameInvalid": "請使用小寫字母、數字和底線，並以字母開頭。",
        "people": "將每一列指派給以下資料表中的人員",
        "peopleNew": "一個新的人員資料表",
        "peopleCreated": "也會建立「{table}」，一個記錄列所指派人員的小型資料表。",
        "noCompose": "使用此名稱的資料表無法用於此頁面。請換一個名稱。",
        "confirm": "建立資料表",
        "noDdl": "Adminium 無法在此建立資料表",
        "halfDone": "資料表已建立，但 Adminium 無法記錄其欄位的含義",
        "halfDoneBody": "無需再次執行——資料表已存在。請在 Studio → 結構描述 中設定其欄位的含義，或請管理員設定。",
        "notReread": "資料表已建立，但 Adminium 暫時無法重新讀取它",
        "notRereadBody": "無需再次執行。請在 Studio → 資料連線 中重新整理結構描述，然後在此選擇新資料表。"
      },
      "related": {
        "title": "使用關聯資料表的日期",
        "help": "不會寫入任何內容到您的資料庫。頁面建立在與此資料表關聯的資料表上，每個項目顯示此資料表中的名稱。",
        "reason": "日期來自「{date}」，每項以「{title}」為標題（透過「{via}」）",
        "chosen": "建立在 {table} 上，每個項目以 {from} 的「{title}」為標題",
        "undo": "返回 {table}"
      }
    },
    "form": {
    ...
    "project": {
      ...
      "changed": {
        "body": "請將這些變更拉取到專案中並部署，否則它們只會留在此伺服器上：",
        "title": "{count, plural, other {此伺服器上有 # 個頁面已變更}}"
      },
      "conflicts": {
        "body": "在你做出選擇之前，此伺服器會保留自己的版本。",
        "title": "{count, plural, other {有 # 個頁面在此處和專案中都已變更}}"
      },
      "fromCode": "此頁面來自 {source}。請在那裡修改。",
      "invalid": {
        "body": "請修正這些檔案。在此之前，會繼續使用最後一個有效版本。",
        "title": "{count, plural, other {有 # 個專案檔案未被套用}}"
      },
      "keepServer": "保留伺服器版本",
      "notConfigured": "其中一些屬於專案未列出的資料庫。將其加入 adminium.config.ts，即可將其頁面保留在專案中。",
      "outside": {
        "body": "它們只存在於此伺服器上。將它們拉取到專案中即可保留：",
        "title": "{count, plural, other {有 # 個頁面不在專案中}}"
      },
      "resolveFailed": "無法完成此變更。",
      "useProject": "使用專案版本"
    },
    "row": {
      "menu": "{title} 的操作"
  ...
  "project": {
    "actions": {
      "bulk": "一筆或多筆記錄",
      "empty": "沒有動作。actions/ 中的檔案會為記錄加上按鈕。",
      "needs": "需要：{permission}",
      "single": "一筆記錄",
      "title": "動作"
    },
    "changes": {
      "empty": "所有頁面與結構描述檔案都與此伺服器一致。",
      "open": "在「頁面」中處理",
      "title": "在此伺服器上已變更"
    },
    "code": {
      "disabled": "未載入：桌面應用程式從不執行專案程式碼",
      "label": "專案程式碼",
      "loaded": "已載入（{when}）",
      "none": "未載入任何內容"
    },
    ...
    "folder": "資料夾",
    "hooks": {
      "empty": "沒有掛鉤。hooks/ 中的檔案會在記錄變更時執行程式碼。",
      "onImport": "也適用於 CSV 匯入",
      "title": "掛鉤"
    },
    "loadFailed": "無法載入專案",
    "mode": {
      "dev": "開發：資料夾與 Studio 保持同步",
      "label": "執行方式",
      "server": "伺服器：資料夾只隨部署而改變"
    },
    "none": {
      "body": "專案是以 `npx @adminiumjs/adminium new` 建立的資料夾。伺服器執行專案時，其頁面、掛鉤與動作會顯示在這裡。",
      "title": "此伺服器未執行任何專案"
    },
    "pages": {
      "empty": "沒有頁面。pages/ 中的 .tsx 檔案會加上你自己的頁面。",
      "hidden": "不在側邊欄中",
      "title": "頁面"
    },
    "permission": {
    ...
    "problems": {
      "body": "請修正這些檔案。其餘專案程式碼正在執行。",
      "title": "{count, plural, other {# 個檔案未能載入}}"
    },
    "status": {
      "changed": "在此伺服器上已變更",
      "conflict": "衝突",
    ...
    "subtitle": "此伺服器執行的專案資料夾，以及它載入的程式碼。",
    "superAdminOnly": "只有超級管理員可以查看此伺服器執行的專案。",
    "title": "專案",
    "version": "Adminium",
    "widgets": {
      "card": "儀表板卡片",
      "cell": "表格儲存格",
      "empty": "沒有小工具。widgets/ 中的檔案會加上表格儲存格或儀表板卡片。",
      "title": "小工具"
    }
  },
  "publicApi": {
  ...
  "remap": {
    ...
    "rules": {
      ...
      "decided": {
        ...
        "stampToday": "當天日期",
        "stampClaim": "已登入者的 {column}",
        "stampAddDays": "{date} 加 {days} 天",
        "stampAddDaysColumn": "{date} 加上 {column} 給出的天數",
        "stampHashOf": "該列的指紋",
        "stampFilled": "當 {column} 首次填寫時設為{what}",
        "sequenceGapless": "按順序的下一個編號，不跳號也不重複",
        "sequenceScope": "按每個 {scope} 分別計數",
    ...
    "unavailableBody": "目前的組建尚未包含重新對應編輯器。等它推出後重新執行產生流程，即可重新對應標籤、型別與關聯。",
    "unavailableTitle": "結構描述重新對應編輯器無法使用"
  },
  "review": {
    "unavailableBody": "此組建尚未包含增強審閱畫面。它將隨差異與套用流程一起推出。",
    "unavailableTitle": "審閱畫面不可用"
  },
  "settings": {
    "globalDefaultsNav": "全域預設值",
    "title": "設定",
  ...
  "settingsAi": {
    "assistant": {
      ...
      "rowData": {
        "label": "允許 {name} 讀取資料表列",
        "hint": "開啟後，{name} 可以把你的角色有權讀取的資料列傳送給已設定的服務供應商 — 已遮罩、每次請求最多 50 列，並列在「已讀取的來源」中。關閉後，它只依據文件與結構描述運作。"
      },
      "save": "儲存",
      "saveFailed": "無法儲存助理設定。請重試。",
      "saved": "助理設定已儲存",
      "subtitle": "它在這裡的名稱，以及它可以讀取的內容。",
      "title": "助理"
    },
    "byo": {
  ...
  "settingsHub": {
    ...
    "email": {
      ...
      "linkOrigin": {
        "error": "請輸入類似 https://admin.example.com 的位址，不要包含路徑。",
        "helper": "密碼重設與邀請連結會開啟此位址。若留空，Adminium 會從下一位登入或儲存變更的管理員自動填入，但使用 localhost 時除外。",
        "label": "電子郵件連結中的位址"
      },
      "pass": {
        "error": "此使用者名稱需要密碼。",
  ...
  "tables": {
    "emptyBody": "此資料庫尚無任何資料表。您仍然可以繼續——建立資料表後，在此連線上使用「重新內省」即可將其匯入。",
    "emptyFileBody": "此結構描述檔未定義任何資料表。請返回並上傳其他檔案，或直接繼續。",
  ...
  "appPublicAccess": {
    ...
    "claimByLink": "透過傳送給他們的連結查詢自己的 {table}",
    "create": "新增至 {table}",
    "update": "變更 {table}",
    "read": "讀取 {table}",
    "later": "將於日後版本提供",
    ...
    "opensWithoutStaff": "讓任何持有連結的人無需員工登入即可開啟 {key} 金鑰讀取的內容",
    "warning": {
      ...
      "noEmailSignIn": "尚未設定電子郵件，因此無法向任何人寄送登入連結。",
      "noPublicAddress": "此應用程式沒有公開位址，因此無法寄送登入連結。請將網域對應到其客戶畫面，或設定伺服器的公開位址。"
    },
