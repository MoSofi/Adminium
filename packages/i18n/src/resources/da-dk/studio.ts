  ...
  "hostedApps": {
    ...
    "install": {
      ...
      "done": {
        ...
        "schema": "Tabeller oprettet: {created} · genbrugt: {reused}"
      },
      "cancel": "Annullér",
      "back": "Tilbage",
      "upload": "Upload",
    ...
    "installed": {
      ...
      "confirmTitle": "Afinstallér denne app?",
      "confirmBody": "Dens flader serveres ikke længere, og pakken slettes. Tabeller, den har oprettet i din database, røres ikke.",
      "confirmPrompt": "Skriv {key} for at bekræfte",
      "confirmCancel": "Annullér",
      "confirmClose": "Luk",
