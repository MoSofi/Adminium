...
export default {
  ...
  "hostedApps": {
    ...
    "install": {
      ...
      "plan": {
        ...
        "installedElsewhere": "{app} er allerede installeret på forbindelsen {connection}. En app kører på én forbindelse: Opdater den der, eller afinstaller den der, før du installerer den på en anden."
      },
      "done": {
    ...
    "update": {
      ...
      "accessSubtitle": "Tjek, hvad denne version lader appens kunder gøre.",
  ...
  "appPublicAccess": {
    ...
    "opensWithoutStaff": "Lad alle med et link åbne det, som nøglen {key} læser, uden at en medarbejder er logget ind",
    "warning": {
