...
export default {
  ...
  "page": {
    ...
    "linkFilters": {
      "pending": "Linkets filtre anvendes",
      "failedTitle": "Linkets filtre kunne ikke anvendes",
      "failedBody": "Listen vises ikke, så den ikke forveksles med den filtrerede.",
      "showAll": "Vis hele listen",
      "group": "Filtre fra linket"
    }
  },
  "mutation": {
  ...
  "kb": {
    ...
    "article": {
      ...
      "publicApi": {
        "title": "Endpoints og nøgler til dine sider",
        "excerpt": "Lad en side eller en anden server kalde de tabeller, du vælger, med nøgler, der er begrænset til endpoints og metoder."
      },
      "apiDocsPage": {
        "title": "API-dokumentationssiden",
        "excerpt": "Udgiv /api-docs, så de, der kalder dit API, kan gennemse det og prøve en forespørgsel."
      },
      "roles": {
