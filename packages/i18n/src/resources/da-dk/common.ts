...
export default {
  ...
  "auth": {
    ...
    "description": "Forbind PostgreSQL, og Adminium genererer en admin-app med eget tema og styr på rettigheder — helt uden kode.",
    "trust": "AGPL-kerne · Selvhostet · Dine data forbliver dine",
    "signIn": {
      "title": "Velkommen tilbage",
      "subtitle": "Log ind på dit Adminium-arbejdsområde.",
      "email": "E-mail",
      ...
      "failed": "Login mislykkedes. Tjek din forbindelse, og prøv igen."
    },
    "forgot": {
    ...
    "otp": {
      ...
      "subtitle": "Indtast den 6-cifrede kode fra din godkendelsesapp.",
      "code": "Engangskode",
      "recoveryCode": "Gendannelseskode",
      "useRecovery": "Mistet din enhed? Brug en gendannelseskode",
  ...
  "nav": {
    ...
    "account": "Konto",
    "signOut": "Log ud",
    "empty": "Sider vises her, når en database er forbundet.",
    "connection": {
      "shared": "Delt",
      "unnamed": "Forbindelse"
    },
  ...
  "topbar": {
    ...
    "studio": "Studio",
    "dataConnections": "Dataforbindelser",
  ...
  "shortcuts": {
    ...
    "subtitle": "Arbejd hurtigere i hele Adminium",
    "close": "Luk",
    "dismiss": "Luk eller afvis",
    ...
    "then": "derefter",
    "footerPre": "Tryk på",
    "footerPost": "når som helst for at åbne dette panel."
  },
  "states": {
  ...
  "notFound": {
    ...
    "body": "Siden, du leder efter, findes ikke eller er blevet flyttet. Tjek adressen, eller gå tilbage til dit dashboard.",
    "errorLine": "Fejl 404",
    "searchPlaceholder": "Søg efter en side…",
  ...
  "page": {
    ...
    "renderError": {
      "title": "Denne side kunne ikke vises"
    },
    "tooNew": {
      "title": "Denne side kræver et nyere Adminium",
      "body": "Denne side blev gemt med konfigurationsversion {version}, men dette build forstår højst version {latest}. Opdatér Adminium for at åbne den."
    },
    "unknownTemplate": {
      "title": "Ukendt sideskabelon",
      "body": "Denne side bruger en skabelon, som dette build ikke kender. Den kan stamme fra et nyere Adminium eller fra en udvidelse, der ikke er installeret."
    }
  },
  "mutation": {
    "created": "Post oprettet",
    "updated": "Post opdateret",
  ...
  "account": {
    "title": "Konto",
    "subtitle": "Identiteten for din aktuelle session. Visningspræferencer og notifikationsindstillinger administreres på deres egne sider.",
    "preferencesLink": "Præferencer",
    "notificationsLink": "Notifikationsindstillinger",
    "name": "Navn",
    "email": "E-mail",
    "roles": "Roller",
    "twoFactor": "Tofaktor",
    ...
    "preferences": {
      ...
      "workspaceDefault": "Arbejdsområdets standard",
      "personal": "Personlig",
      "usingDefault": "Bruger arbejdsområdets standard ({value})",
      "reset": "Nulstil til arbejdsområdets standard",
      "resetFailed": "Denne præference kunne ikke nulstilles. Prøv igen.",
      "appliesInstantly": "Ændringer træder i kraft med det samme og gemmes i din profil."
    }
  },
  "settings": {
    "defaults": {
      "title": "Globale standarder",
      "subtitle": "Standarder for udseende og sprog for hele arbejdsområdet.",
      "explainer": "Disse standarder gælder for alle brugere, medmindre de tilsidesætter dem. Alle kan vælge deres egne præferencer under Profil → Præferencer — personlige præferencer vinder altid for den bruger.",
      "appearanceHeading": "Standarder for udseende",
      "languageHeading": "Standarder for sprog og region",
      "adoption": "{following, number} af {total, plural, one {# bruger} other {# brugere}} følger denne standard.",
      "weekStartNote": "Ugens første dag og talformater følger sproget.",
      "save": "Gem standarder",
    ...
    "translations": {
      ...
      "subtitle": "Ret enhver formulering i Adminium, vælg hvilke sprog folk kan vælge, og tilføj dine egne.",
      "warning": "Fejlmeddelelser og login-tekster kan også redigeres. Det er dem, folk læser, når noget går galt, så ret dem med omtanke.",
      "editor": {
        "heading": "Rediger oversættelser"
      },
      "localeLabel": "Sprog",
      "groupLabel": "Område",
      ...
      "state": {
        "all": "Alt",
        "overridden": "Kun tilpassede",
        "untranslated": "Kun uoversatte",
        "stale": "Engelsk ændret siden"
      },
      "searchLabel": "Søg",
      "searchPlaceholder": "Nøgle eller engelsk tekst",
      "loading": "Indlæser tekster…",
      "noMatches": "Ingen tekster matcher de filtre.",
      "count": "{total, plural, one {# tekst} other {# tekster}}",
      "badge": {
        "custom": "Tilpasset",
        "stale": "Engelsk ændret",
        "a11y": "Tilgængeligt navn"
      },
      "sourceLabel": "Engelsk original",
      "valueLabel": "Oversættelse",
      "save": "Gem",
      "saved": "Oversættelse gemt",
      "resetAction": "Nulstil til indbygget",
      "reset": "Nulstillet til den indbyggede tekst",
      "locales": {
        "heading": "Tilgængelige sprog",
        "help": "Slå et sprog fra for at fjerne det fra alle sprogvælgere. De, der allerede bruger det, beholder det, indtil de vælger et andet."
      },
      "locale": {
        "builtin": "Indbygget",
        "custom": "Brugerdefineret",
        "overrides": "{count, plural, =0 {ingen tilpasset tekst} one {# tilpasset tekst} other {# tilpassede tekster}}",
        "enable": "Slå til",
        "disable": "Slå fra",
        "delete": "Slet",
        "deleted": "Sprog fjernet",
        "deletedDetail": "{users, plural, one {# person} other {# personer}} er sat tilbage til arbejdsområdets standard; {strings, plural, one {# oversættelse} other {# oversættelser}} er slettet.",
        "deleteFailed": "Sproget kunne ikke fjernes",
        "add": "Tilføj et sprog",
        "added": "Sprog tilføjet",
        "create": "Tilføj sprog",
        "id": "Sprogkode",
        "intlTag": "Formatregler fra",
        "native": "Navn på sproget selv",
        "english": "Navn på engelsk",
        "dir": "Tekstretning",
        ...
        "latin": "Latinsk",
        "arabic": "Arabisk",
        "cjk": "Kinesisk / japansk / koreansk",
        "intlHelp": "Formatregler afgør, hvordan tal, datoer og flertalsformer opfører sig. Vælg det nærmeste sprog, der allerede har dem — det behøver ikke at matche din sprogkode."
      }
    }
  },
  "onboarding": {
    "title": "Kom godt i gang",
    "subtitle": "Nogle få trin for at gøre dit arbejdsområde klar.",
    "loading": "Indlæser din tjekliste…",
    "welcome": "Velkommen til Adminium, {name} 👋",
    "progressBody": "Du har gennemført {done} af {total} opsætningstrin. Gennemfør resten for at låse hele arbejdsområdet op.",
    "completeBody": "Alt er klar — dit arbejdsområde er fuldt konfigureret.",
    "ringLabel": "{done} af {total} trin gennemført",
    "done": "Færdig",
    "skip": "Spring over for nu",
    "goToWorkspace": "Gå til arbejdsområde",
    "help": {
      "title": "Brug for hjælp?",
      "body": "Vi er her for at hjælpe dig hurtigt i gang."
    },
    "steps": {
      "connectDatabase": {
        "title": "Forbind en database",
        "desc": "Peg Adminium mod din Postgres, MySQL eller SQLite — en skrivebeskyttet rolle er nok.",
        "time": "5 min",
        "action": "Forbind"
      },
      "chooseTables": {
        "title": "Vælg dine tabeller",
        "desc": "Vælg hvilke tabeller der bliver til sider — personlige data maskeres som standard.",
        "time": "2 min",
        "action": "Vælg"
      },
      "inviteTeammates": {
        "title": "Inviter holdkammerater",
        "desc": "Få dit team med til at udforske og samarbejde.",
        "time": "2 min",
        "action": "Inviter"
      },
      "workspaceDefaults": {
        "title": "Angiv standarder",
        "desc": "Tema, accent, tæthed og sprog for alle.",
        "time": "1 min",
        "action": "Angiv"
      }
    },
    "entry": {
      "wayBack": "Kom godt i gang · {done}/{total}",
      "dismiss": "Skjul tjeklisten",
      "continue": "Fortsæt opsætning",
      "banner": "Færdiggør opsætningen af dit arbejdsområde — {done} af {total} trin klaret."
    }
  },
  "views": {
    "baseView": "Alle poster",
    "menuLabel": "Gemte visninger",
    "saveAs": "Gem aktuel som visning…",
    "updateActive": "Opdater „{name}“",
    "rename": "Omdøb…",
    "setDefault": "Angiv som standard",
    "delete": "Slet…",
    "saveTitle": "Gem visning",
    "save": "Gem visning",
    "renameTitle": "Omdøb visning",
    "saveName": "Gem navn",
    "nameLabel": "Visningsnavn",
    "namePlaceholder": "f.eks. Aktive denne måned",
    "nameRequired": "Angiv et navn til denne visning.",
    "saveFailed": "Visningen kunne ikke gemmes.",
    "deleteTitle": "Slet visning",
    "deleteBody": "Dette fjerner den gemte visning. Dine data påvirkes ikke.",
    "deletePrompt": "Skriv visningens navn for at bekræfte",
    "deleteConfirm": "Slet visning",
    "savedToast": "Visning „{name}“ gemt.",
    "updatedToast": "Visning „{name}“ opdateret.",
    "defaultToast": "„{name}“ er nu standardvisningen.",
    "deletedToast": "Visning „{name}“ slettet."
  },
  "builder": {
    "view": "Vis",
    "edit": "Rediger",
    ...
    "saving": "Gemmer…",
    "savedShort": "Gemt",
    "options": "Dashboard-indstillinger",
    "resetLayout": "Nulstil layout",
    "resetTitle": "Nulstil til det delte layout?",
    "resetBody": "Dette fjerner dine personlige ændringer og gendanner det dashboard, alle ser. Dine data påvirkes ikke.",
    "resetConfirm": "Nulstil layout",
    "resetDone": "Layout nulstillet til den delte standard.",
    "sharedNote": "Du redigerer det delte dashboard, som alle ser.",
    "personalNote": "Du redigerer dit personlige layout — kun du ser disse ændringer.",
    "savedShared": "Dashboard gemt for alle med adgang.",
    "empty": "Dette dashboard har endnu ingen widgets.",
    "emptyAction": "Tilføj widget",
    "palette": {
      "title": "Tilføj widget",
      "count": "{count} widgets",
      "searchLabel": "Søg widgets",
      "searchPlaceholder": "Søg widgets…",
      "clear": "Ryd søgning",
      "noResults": "Ingen widgets matcher “{query}”.",
      "add": "Tilføj {name}",
      "added": "{name} tilføjet."
    },
    "inspector": {
      "title": "Konfigurer widget",
      "empty": "Denne widget har ingen indstillinger at konfigurere.",
      "locked": "Låst",
      "lockedHint": "Dette felt er angivet af kilden og kan ikke redigeres her.",
    ...
    "item": {
      ...
      "duplicate": "Dupliker {name}",
      "remove": "Fjern {name}",
      "removed": "{name} fjernet.",
      "duplicated": "{name} duplikeret.",
      "unboundHint": "Denne widget viser eksempeldata her og på live-siden. Åbn Konfigurer for at forbinde den til en tabel.",
      "unbound": "Eksempeldata"
    },
    "families": {
      "kpi": "KPI’er",
      "charts": "Diagrammer",
    ...
    "discardTitle": "Kassér dine ændringer?",
    "discardBody": "Dashboardet vender tilbage til, som det så ud, da du åbnede editoren. Dine data påvirkes ikke.",
    "discardConfirm": "Kassér ændringer",
    "keepEditing": "Fortsæt redigering",
    "discarded": "Ændringer kasseret.",
    "binding": {
      "addFilter": "Tilføj filter",
      "brokenBody": "Den svarer ikke længere til en forespørgsel, som denne version forstår, så widgetten viser en fejl på live-siden.",
      "brokenTitle": "Denne widgets forespørgsel er defekt",
      "bucketColumn": "Datokolonne",
      "bucketRequired": "Vælg den kolonne, der indeholder datoen.",
      "bucketUnit": "Gruppér tid efter",
      "columnNone": "Ingen",
      "columnPlaceholder": "Vælg en kolonne…",
      "connect": "Forbind til data",
      "edit": "Rediger forespørgsel",
      "event": {
        "category": "Kategorikolonne (valgfri)",
        "date": "Startdatokolonne",
        "end": "Slutdatokolonne (valgfri)",
        "title": "Titelkolonne"
      },
      "filterColumnRequired": "Vælg en kolonne.",
      "filterColumn": "Kolonne",
      "filterListHelper": "Adskil værdier med kommaer.",
      "filterOp": "Betingelse",
      "filterValue": "Værdi",
      "fn": {
        "avg": "Gennemsnit",
        "countDistinct": "Antal forskellige værdier",
        "count": "Antal rækker",
        "max": "Maksimum",
        "min": "Minimum",
        "sum": "Sum"
      },
      "groupByColumns": "Kolonner",
      "groupByRequired": "Denne visning kræver en opdelingskolonne.",
      "groupByRows": "Rækker",
      "groupBy": "Gruppér efter",
      "incompleteBody": "Udfyld de fremhævede felter — en halvfærdig forespørgsel ville fejle på det live dashboard.",
      "incompleteTitle": "Denne forespørgsel er ikke færdig",
      "limit": "Maks. antal rækker der hentes",
      "loadingSchema": "Indlæser tabeller…",
      "lossyBody": "Dele af den — ekstra målinger, sorteringer eller links til sidefiltre — vises ikke her og går tabt, hvis du gemmer.",
      "lossyTitle": "Denne forespørgsel er mere avanceret end editoren",
      "measureColumnRequired": "Denne beregning kræver en kolonne.",
      "measureColumn": "Af kolonne",
      "measureFn": "Beregn",
      "noConnectionBody": "Widgets kan kun bindes på en side, der hører til en forbindelse.",
      "noConnectionTitle": "Denne side har ingen databaseforbindelse",
      "noDateColumns": "Denne tabel har ingen dato- eller tidsstempelkolonne.",
      "noFilters": "Ingen filtre — hver eneste række i tabellen tælles med.",
      "noSnapshotBody": "Tabeller og kolonner kommer fra forbindelsens seneste introspektion. Kør introspektion i Studio, og åbn derefter denne editor igen.",
      "noSnapshotTitle": "Intet skema-snapshot for denne forbindelse",
      "op": {
        "between": "er mellem",
      ...
      "orderAsc": "Ældste / laveste først",
      "orderBy": "Sortér efter",
      "orderDesc": "Nyeste / højeste først",
      "orderDir": "Retning",
      "orderNone": "Databasens rækkefølge",
      "pickTableFirst": "Vælg en tabel for at vælge dens kolonner.",
      "removeFilter": "Fjern filter",
      "remove": "Fjern datakilde",
      "save": "Brug denne forespørgsel",
      "sectionBreakdown": "Opdeling",
      "sectionColumns": "Kolonner",
      "sectionFilters": "Filtre",
      "sectionMeasure": "Måling",
      "sectionRows": "Rækker",
      "sectionSource": "Kilde",
      "sectionTime": "Tidsakse",
      "sectionWindow": "Periode",
      "selectColumns": "Kolonner der skal vises",
      "selectRequired": "Vælg mindst én kolonne at vise.",
      "shape": {
        "calendarEvents": "Daterede begivenheder",
        "categorical": "En værdi pr. kategori",
        "distribution": "Spredningen i én kolonne",
        "matrix": "Et gitter med rækker og kolonner",
        "metricDelta": "Et tal sammenlignet med den foregående periode",
        "multiTimeseries": "Én linje over tid pr. kategori",
        "recordList": "En liste af rækker",
        "record": "Én række",
        "singleMetric": "Ét enkelt tal",
        "stream": "Et live-feed af de seneste rækker",
        "timeseries": "En værdi over tid",
        "tree": "En værdi pr. kategori, opdelt i to niveauer",
        "geoPoints": "En værdi pr. sted eller område",
        "flows": "Hvor meget der flytter sig fra én kategori til en anden",
        "ohlc": "Åbning, højeste, laveste og lukning pr. periode",
        "booleanMap": "Et til/fra-flag pr. nøgle"
      },
      "shapeHelper": "Ændrer du dette, ændres det, hvilke forespørgselsindstillinger der gælder.",
      "shapeLabel": "Hvad denne widget viser",
      "summaryColumns": "{count, plural, one {# kolonne} other {# kolonner}}",
      "summaryFilters": "{count, plural, one {# filter} other {# filtre}}",
      "tableEmpty": "Ingen matchende tabel.",
      "tablePlaceholder": "Søg i tabeller…",
      "tableRequired": "Vælg en tabel at forespørge.",
      "table": "Tabel eller view",
      "title": "Datakilde",
      "unbindableBody": "Den viser en dataform, som forespørgselsmotoren endnu ikke bygger, så den gengiver sit eget eksempelindhold.",
      "unbindableTitle": "Denne widget kan endnu ikke forespørge data",
      "unboundBody": "Den viser eksempeltal her OG på live-siden. Forbind den til en tabel for at vise rigtige data.",
      "unboundTitle": "Ikke forbundet til dine data",
      "unit": {
        "day": "Dagligt",
        "hour": "Hver time",
        "month": "Månedligt",
      ...
      "valueColumnRequired": "Vælg den kolonne, der skal måles.",
      "valueColumn": "Værdikolonne",
      "windowColumn": "Datokolonne",
      "windowLast": "Seneste",
      "windowNone": "Al tid",
      "windowRequired": "Sammenligning med den foregående periode kræver en datokolonne.",
      "windowUnit": {
        "day": "dage",
        "hour": "timer",
        "month": "måneder",
      ...
      "windowUnitLabel": "Enhed",
      "role": {
        "flagKey": "Nøglekolonne",
        "flagValue": "Til/fra-kolonne"
      },
      "roleColumnsRequired": "Udfyld hver påkrævet kolonne, og lad ingen stå tomme før en, du har udfyldt — disse kolonner læses i rækkefølge."
    }
  },
  "setup": {
  ...
  "desktop": {
    ...
    "requireLogin": {
      "label": "Kræv login på denne enhed",
      "description": "Adminium logger dig normalt ind automatisk på denne computer. Slå dette til for at blive bedt om din adgangskode ved hver opstart — en god idé, hvis andre kan bruge maskinen. Det træder i kraft, næste gang du åbner Adminium.",
    ...
    "lan": {
      ...
      "manageTeam": "Administrér brugere og roller"
    },
    "setup": {
  ...
  "audit": {
    ...
    "category": {
      ...
      "data": "Poster",
      "export": "Import og eksport",
      "llm": "AI-assistance",
      "rbac": "Roller og rettigheder",
      "schema": "Skema",
    ...
    "drawer": {
      ...
      "field": "Felt",
      "ip": "IP-adresse",
      "noChanges": "Denne handling registrerede ingen før/efter-øjebliksbilleder.",
      "none": "Ingen",
    ...
    "empty": {
      ...
      "filtered": {
        "body": "Udvid datointervallet, eller ryd kategorifilteret.",
        "title": "Intet matcher disse filtre"
      },
      "title": "Der er ikke logget noget endnu"
    },
    "filterActor": "Aktør-id",
    "filterCategoryAny": "Alle kategorier",
    "filterCategory": "Filtrér efter kategori",
    "filterFrom": "Fra",
    "filterTo": "Til",
    "listFailed": {
      "title": "Auditloggen kunne ikke indlæses"
    },
  ...
  "security": {
    "password": {
      ...
      "failed": "Din adgangskode kunne ikke skiftes",
      "helper": "Mindst 8 tegn.",
    ...
    "sessions": {
      "expires": "Udløber {at}",
      "failedBody": "Denne liste er det eneste sted, der viser, hvor din konto er logget ind, så betragt en tom liste som ukendt frem for som ingen.",
      "failed": "Dine sessioner kunne ikke læses",
      "ip": "IP {ip}",
      "loading": "Leder efter andre enheder, der er logget ind…",
      "noIp": "Ingen IP registreret",
      "revokeBody": "Sessionen slutter med det samme, og den, der bruger den, skal logge ind igen.",
      "revokeFailed": "Den enhed kunne ikke logges ud",
      "revokeTitle": "Log denne enhed ud",
      "revoke": "Log ud",
      "seenUnknown": "Sidst set: ukendt",
      "seen": "Sidst set {since}",
      "thisDevice": "Denne enhed",
      "title": "Logget ind",
      "unknownDevice": "Ukendt enhed"
    },
    "subtitle": "Din adgangskode, din anden faktor og alle de steder, du er logget ind.",
    "title": "Sikkerhed",
    "twoFactor": {
      "activateFailed": "Den kode blev ikke accepteret",
      "activate": "Slå tofaktor til",
      "body": "En godkendelsesapp genererer en 6-cifret kode, som Adminium beder om efter din adgangskode.",
      "code": "Kode fra din app",
      "copyKey": "Kopiér opsætningsnøgle",
      "copyLink": "Kopiér opsætningslink",
      "disableBody": "Din konto går tilbage til kun adgangskode, og dine gendannelseskoder holder op med at virke.",
      "disableConfirm": "Slå det fra",
      "disableFailed": "Tofaktor kunne ikke slås fra",
      "disablePassword": "Din adgangskode",
      "disableTitle": "Slå tofaktorgodkendelse fra",
      "disable": "Slå tofaktor fra",
      "enrollFailed": "Opsætningen kunne ikke startes",
      "enroll": "Konfigurér tofaktor",
      "hide": "Skjul opsætningsnøgle",
      "off": "Slået fra",
      "on": "Slået til",
      "recovery": {
        "body": "Hver kode logger dig ind én gang, hvis du mister din godkendelsesapp. De vises kun nu.",
        "copy": "Kopiér koder",
        "title": "Gem dine gendannelseskoder"
      },
      "reveal": "Vis opsætningsnøgle",
      "secretHelper": "Indsæt opsætningslinket i din godkendelsesapp, eller skriv nøglen ind i hånden.",
      "secret": "Opsætningsnøgle",
      "title": "Tofaktorgodkendelse"
    }
  },
  "team": {
    "action": {
      "reactivate": "Reaktivér",
      "remove": "Slet",
      "resend": "Nyt link",
      "roles": "Roller",
      "suspend": "Suspendér"
    ...
    "counts": "{active} aktive · {invited} inviterede · {suspended} suspenderede",
    "empty": {
      "body": "Inviter en holdkammerat for at give vedkommende sit eget login og sin egen rolle.",
      "filtered": {
        "body": "Ryd filtrene for at se hele kataloget.",
        "title": "Ingen matcher disse filtre"
      },
      "title": "Kun du har en konto"
    },
    "filterRoleAny": "Alle roller",
    "filterRole": "Filtrér efter rolle",
    "filterStatusAny": "Alle statusser",
    "filterStatus": "Filtrér efter status",
    "invite": {
      "copied": "Kopieret",
    ...
    "inviteDialog": {
      "description": "Adminium opretter kontoen og giver dig et engangs-aktiveringslink, du kan give videre.",
      "emailPlaceholder": "navn@example.com",
      "email": "E-mail",
      "failed": "Invitationen kunne ikke oprettes",
      "namePlaceholder": "f.eks. Dana Osei",
      "name": "Navn",
      "rolesHelper": "Vælg den mindst privilegerede rolle, der lader vedkommende passe sit arbejde. Du kan ændre det senere.",
      "roles": "Roller",
      "submit": "Opret invitation",
      "title": "Inviter en holdkammerat"
    },
    "listFailed": {
      "title": "Kataloget kunne ikke indlæses"
    },
    "loadMore": "Indlæs flere",
    "neverSignedIn": "Har aldrig logget ind",
    ...
    "rolesDialog": {
      "description": "En bruger får summen af alle de roller, vedkommende har.",
      "failed": "Rollerne kunne ikke ændres",
      "title": "Roller for {name}"
    },
    "rolesLocked": "Ændring af roller kræver rettigheden „Administrér roller“.",
    "search": "Søg efter navn eller e-mail",
    "status": {
      "active": "Aktiv",
      "invited": "Inviteret",
  ...
  "email": {
    "blank": {
      ...
      "heading": "Overskriften kommer her",
      "para": "Begynd at skrive din e-mail…",
      "preheader": "Forhåndsvisningstekst",
      "subject": "Emnelinje"
    },
    "campaignSent": {
      "body": "{sent} sendt · {failed} mislykkedes",
      "title": "Kampagne sendt: {name}"
    },
    "copySuffix": "{name} (kopi)",
    "linkFallback": "Hvis knappen ikke virker, så indsæt dette link i din browser: {url}",
    "notification": {
      "action": "Åbn {appName}",
      "footer": "Du modtager denne e-mail, fordi e-mailnotifikationer er slået til for din {appName}-konto. Du kan slå dem fra i dine notifikationsindstillinger.",
      "name": "Notifikation"
    },
    "passwordReset": {
      "action": "Vælg en ny adgangskode",
      "heading": "Nulstil din adgangskode",
      "intro": "Hej {name}. Vi har modtaget en anmodning om at nulstille adgangskoden til {email}.",
      "name": "Nulstilling af adgangskode",
      "notice": "Dette link virker kun én gang og udløber om {expiresInMinutes} minutter. Hvis du ikke har bedt om at få nulstillet din adgangskode, kan du ignorere denne e-mail — din nuværende adgangskode forbliver aktiv.",
      "subject": "Nulstil din adgangskode til {appName}"
    },
    "starters": {
      "digest": {
        "boxLabel": "Fuldførte opgaver",
        "cta": "Se hele rapporten",
        "heading": "Sådan gik din uge",
        "name": "Ugentligt overblik",
        "para1": "Dit team fuldførte 128 opgaver og udgav 3 versioner. Omsætningen er steget 12 % i forhold til sidste uge — flot arbejde.",
        "preheader": "Et hurtigt overblik over din uge",
        "subject": "Din uge i tal 📊"
      },
      "extras": {
        "cityTax": "Kommuneafgift (2 %)",
        "community": "Fællesskab",
        "contact": "Kontakt os",
        "delivered": "Leveret",
        "delivery": "Leveringsforløb",
        "help": "Spørgsmål? Kontakt os",
        "hero": "Hero-billede — 600 × 240",
        "item1": "Workshopbillet",
        "item1Meta": "Lør. 12. sep. · 2 pladser",
        "item2": "Ekstra lagerplads",
        "item2Meta": "250 GB",
        "order": "Ordreoversigt",
        "ordered": "Bestilt",
        "payments": "Betalingshistorik",
        "processing": "Behandles",
        "quote": "{appName} halverede vores tid på rapportering.",
        "quoteAuthor": "Priya R., Northwind Co",
        "refund": "Refusionspolitik",
        "refundText": "Fuld refusion inden for 30 dage efter købet. Kontakt support for at starte en returnering.",
        "shipped": "Afsendt",
        "stat1": "Opgaver løst",
        "stat2": "Udgivelser",
        "stat3": "Omsætning op",
        "stateTax": "Regionsafgift (6 %)",
        "step1": "Invitér dit team",
        "step2": "Forbind dine data",
        "step3": "Byg dit første dashboard",
        "support": "{appName}-support",
        "tax": "Afgiftsoversigt",
        "website": "Website"
      },
      "failed": {
        "boxLabel": "Forfaldent beløb",
        "cta": "Opdatér betalingsmetode",
        "heading": "Din betaling gik ikke igennem",
        "name": "Betaling mislykkedes",
        "para1": "Vi forsøgte at trække beløbet for ordre #{orderNumber} på dit kort, men betalingen mislykkedes. Opdatér venligst din betalingsmetode for at undgå forsinkelse.",
        "para2": "Vi prøver igen om 3 dage.",
        "preheader": "Opdatér din betalingsmetode",
        "subject": "Handling påkrævet: betaling mislykkedes"
      },
      "feature": {
        "cta": "Prøv Automatiseringer",
        "heading": "Automatisér rutinearbejdet",
        "name": "Funktionsnyhed",
        "para1": "Sig hej til Automatiseringer — byg udløser → handling-forløb, der kører af sig selv. Byd nye brugere velkommen, følg op på ordrer, der er gået i stå, og fordel arbejdet på autopilot.",
        "preheader": "Automatisér rutinearbejdet",
        "subject": "Her er Automatiseringer ⚡"
      },
      "feedback": {
        "cta": "Del feedback",
        "heading": "Vi vil gerne høre din feedback",
        "name": "Feedbackanmodning",
        "para1": "Du har brugt {appName} et stykke tid nu. Vil du bruge to minutter på at fortælle os, hvordan det går? Dine svar former det, vi bygger næste gang.",
        "preheader": "To minutter, ét spørgsmål",
        "subject": "Hvordan gik det, {firstName}?"
      },
      "footer": "Du modtager denne e-mail, fordi du har en {appName}-konto.\nSpørgsmål? Svar på denne e-mail.",
      "monthly": {
        "boxLabel": "Månedlig omsætning",
        "cta": "Se hele rapporten",
        "heading": "Din {month} i overblik",
        "name": "Månedsrapport",
        "para1": "Her er historien om din måned på {appName}. Dit team udgav mere og arbejdede hurtigere — omsætningen steg 18 % i forhold til sidste måned.",
        "para2": "Dyk ned i den fulde oversigt for at se præcis, hvad der drev tallene.",
        "preheader": "Din måned i overblik",
        "subject": "Din rapport for {month} er klar 📈"
      },
      "paused": {
        "boxLabel": "Data gemmes i",
        "boxValue": "30 dage",
        "cta": "Genaktivér konto",
        "heading": "Din konto er sat på pause",
        "name": "Konto på pause",
        "para1": "Din konto er sat på pause, så du kan ikke logge ind lige nu. Bare rolig — dine data er sikre og gemmes i 30 dage.",
        "para2": "Genaktivér når som helst, og fortsæt præcis, hvor du slap.",
        "preheader": "Dine data er sikre",
        "subject": "Din {appName}-konto er sat på pause"
      },
      "receipt": {
        "attachment": "Kvittering som PDF",
        "boxLabel": "Trukket beløb",
        "cta": "Se din ordre",
        "heading": "Tak for din ordre",
        "name": "Ordrekvittering",
        "para1": "Dette bekræfter, at vi har modtaget din betaling for ordre #{orderNumber}. En kopi af din kvittering er vedhæftet til dine papirer.",
        "preheader": "Tak for din ordre",
        "subject": "Din kvittering fra {appName}"
      },
      "reengage": {
        "cta": "Hop tilbage",
        "heading": "Det er et stykke tid siden, {firstName}",
        "name": "Genaktivering",
        "para1": "Der er sket meget, siden du sidst var her. Vi har udgivet Automatiseringer, hurtigere dashboards og en helt ny rapportbygger.",
        "para2": "Kom og kig — din konto er lige, hvor du forlod den.",
        "preheader": "Se, hvad der er nyt",
        "subject": "Vi savner dig på {appName}"
      },
      "reminder": {
        "cta": "Administrér aftale",
        "heading": "Vi ses snart, {firstName}",
        "name": "Aftalepåmindelse",
        "para1": "Din aftale er {date} kl. {time}. Hvis du har brug for at flytte den, så svar på denne e-mail eller brug knappen nedenfor.",
        "para2": "Kom gerne et par minutter før.",
        "preheader": "Vi ses kl. {time}",
        "subject": "Din aftale er {date}"
      },
      "shipped": {
        "cta": "Følg leveringen",
        "heading": "Din ordre er afsendt",
        "name": "Leveringsopdatering",
        "para1": "Gode nyheder, {firstName} — ordre #{orderNumber} har forladt vores lager og er på vej. Følg den med knappen nedenfor.",
        "preheader": "Følg din levering",
        "subject": "Din ordre #{orderNumber} er på vej"
      },
      "verify": {
        "cta": "Bekræft e-mailadresse",
        "heading": "Bekræft din e-mail",
        "name": "Bekræft din e-mail",
        "para1": "Tak, fordi du oprettede dig! Bekræft venligst din e-mailadresse for at aktivere din {appName}-konto. Det er med til at holde din konto sikker.",
        "preheader": "Ét hurtigt trin",
        "subject": "Bekræft din e-mailadresse"
      },
      "welcome": {
        "cta": "Åbn {appName}",
        "heading": "Velkommen om bord, {firstName}!",
        "name": "Velkomst-e-mail",
        "para1": "Vi er glade for at have dig på {appName}. Din konto er klar — sådan kommer du i gang.",
        "para2": "Brug for en hånd? Svar på denne e-mail når som helst, så hjælper et rigtigt menneske dig.",
        "preheader": "Lad os få dig i gang",
        "subject": "Velkommen til {appName} 👋"
      }
    },
    "untitled": {
      "campaign": "Unavngiven kampagne",
      "template": "Unavngiven skabelon"
    },
    "userInvite": {
      "action": "Accepter invitationen",
      "heading": "Du er blevet inviteret",
      "intro": "{inviterName} har inviteret dig til at deltage i {appName}. Accepter invitationen for at vælge en adgangskode til {email} og logge ind.",
      "inviterFallback": "En administrator",
      "name": "Teaminvitation",
      "notice": "Denne invitation virker kun én gang og udløber om {expiresInDays} dage. Hvis du ikke forventede den, kan du ignorere denne e-mail.",
      "subject": "Du er blevet inviteret til {appName}"
    }
  },
  "invoices": {
    "copySuffix": "{name} (kopi)",
