  ...
  "studio": {
    ...
    "meta": {
      ...
      "v1Note": {
        ...
        "body": "Denne server valgte sit metalager ved første opstart. Dette trin validerer, at dit valg er kompatibelt med denne forbindelse, og registrerer det — serveren håndhæver samme regel uafhængigt (409 META_PLACEMENT_INVALID). Flytning af et eksisterende metalager er en driftsopgave (M10)."
      }
    },
    "intent": {
