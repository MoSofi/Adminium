...
export default {
  ...
  "formDialog": {
    "calendar": {
      "days": "Dage i {month}",
      "next": "Næste måned",
      "noTimes": "Ingen tidspunkter denne dag",
      "previous": "Forrige måned",
      "times": "Tidspunkter",
      "unchecked": "Denne måned har for mange bookinger til at blive tjekket her."
    },
    "control": {
      "fewer": "Én mindre",
      "hide": "Skjul",
      "more": "Én mere",
      "removeChip": "Fjern {value}",
      "reveal": "Vis",
      "upTo": "op til {size} MB"
    },
    "cta": {
    ...
    "footnote": {
      "required": "Obligatoriske felter er markeret med *"
    },
    "issue": {
      ...
      "integer": "Indtast et helt tal.",
      "tooShort": "Brug mindst {n} tegn.",
      "tooLong": "Brug højst {n} tegn.",
      "tooSmall": "Skal være {min} eller derover.",
      "tooLarge": "Skal være {max} eller derunder.",
      "outOfRange": "Dette tal er uden for intervallet.",
      "duplicate": "Allerede tilføjet.",
      "form": "Nogle værdier blev afvist. Tjek de markerede felter."
    },
    "lines": {
      "add": "Tilføj linje",
      "remove": "Fjern linje {n}"
    },
    "quick": {
      "today": "I dag",
      "tomorrow": "I morgen",
    ...
    "reference": {
      "noAccess": "Du kan ikke læse {table}, så dette kan ikke ændres her."
    },
    "subtitle": {
      "sections": "Oplysninger: {list}"
    },
    "title": {
      "create": "Ny {entity}",
      "edit": "Rediger {entity}"
  ...
  "widgets": {
    ...
    "domain": {
      ...
      "blockEmailHeading": {
        "emptyTitle": "Ingen overskrift",
        "emptyBody": "Tilføj overskriftstekst til denne e-mail."
      },
      "blockEmailText": {
        "emptyTitle": "Ingen tekst",
        "emptyBody": "Tilføj et afsnit til denne e-mail."
      },
      "blockEmailButton": {
        "emptyTitle": "Ufuldstændig knap",
        "emptyBody": "En knap skal have både tekst og et link for at blive sendt."
      },
      "blockEmailSpacer": {
        "label": "{size} px mellemrum"
      },
      "blockEmailFooter": {
        "emptyTitle": "Ingen sidefod",
        "emptyBody": "Juridisk tekst, adresse og afmelding hører til her."
      }
    },
    "media": {
      "fileBrowser": {
  ...
  "templates": {
    "crud": {
      ...
      "toast": {
        ...
        "createdMany": "{count, plural, one {# post oprettet.} other {# poster oprettet.}}",
    ...
    "builder": {
      ...
      "blocks": {
        ...
        "email-heading": "Overskrift",
        "email-text": "Afsnit",
        "email-button": "Handlingsknap",
        "email-divider": "Skillelinje",
        "email-spacer": "Mellemrum",
        "email-footer": "Sidefod"
      },
      "starters": {
        "titles": {
  ...
  "lists": {
    "name": {
      "countries": "Lande",
      "us-states": "Amerikanske delstater",
      "gender": "Køn"
    },
    "gender": {
      "female": "Kvinde",
