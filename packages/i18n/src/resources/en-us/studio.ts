...
export default {
  ...
  "remap": {
    ...
    "rules": {
      ...
      "decided": {
        ...
        "stampByOriginOwn": "“{public}” from the public side, and what staff choose from staff",
        "stampCopy": "the value of {column}",
      ...
      "shape": {
        "setBy": "Set by {addOn}",
        "confirmTitle": "Switch off a rule set by {addOn}?",
        "numbers": "Numbers may repeat or skip.",
        "totals": "Totals will be whatever is typed.",
        "edits": "Sent invoices can be edited.",
        "kept": "{addOn} will stop filling this in.",
  ...
  "appPublicAccess": {
    ...
    "claimByLink": "Look up their own {table} through a link sent to them",
    "create": "Add to {table}",
    "update": "Change {table}",
    "read": "Read {table}",
