...
export default {
  ...
  "bookingConfirmation": {
    ...
    "subject": "Your table at {venue} is booked",
    "preheader": "Booking {code} · {when} · party of {party}",
    "heading": "Your table is booked",
    "intro": "We’re holding a table for you at {venue}. Show this code when you arrive.",
    "codeLabel": "Booking code",
    "when": "When: {when}",
    "party": "Party: {party}",
    "guest": "Name: {name}",
    "action": "Manage your booking",
    "cancel": "You can cancel online up to {cancelHours} hours before.",
  ...
  "signInCode": {
    ...
    "heading": "Your code",
    "intro": "Type this code to confirm it’s you. It works for {minutes} minutes.",
    "codeLabel": "Code",
    "notice": "If you didn’t ask for it, you can ignore this email: nobody can use it without the code.",
    "footer": "{appName}"
  },
  "emailChanged": {
    "name": "Email address changed",
    "subject": "Your email address at {appName} was changed",
    "heading": "Your email address was changed",
    "intro": "Hi {name}, the email address on your record at {appName} is now {newEmail}.",
