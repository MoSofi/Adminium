  ...
  "templates": {
    "crud": {
      ...
      "toast": {
        ...
        "createdMany": "{count, plural, one {# record created.} other {# records created.}}",
      ...
      "linkFilter": {
        ...
        "today": "today",
        "eq": "{name} is {value}",
        "neq": "{name} is not {value}",
        "in": "{name} is one of {values}",
        "gt": "{name} more than {value}",
        "gte": "{name} {value} or more",
        "lt": "{name} less than {value}",
        "lte": "{name} {value} or less",
        "after": "{name} after {value}",
        "before": "{name} before {value}",
        "onOrAfter": "{name} on or after {value}",
        "onOrBefore": "{name} on or before {value}",
        "thisMonth": "{name} this month",
        "lastMonth": "{name} last month",
        "set": "{name} is filled in",
        "unset": "{name} is empty",
    ...
    "dashboard": {
      ...
      "day": {
        ...
        "week": "This week",
        "pick": "Pick a day",
        "pickHelp": "One day at a time, on the venue’s clock.",
        "cancel": "Cancel",
        "show": "Show day"
      }
    },
