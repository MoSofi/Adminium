...
export default {
  ...
  "studio": {
    "source": {
      ...
      "readOnlyRole": {
        ...
        "body": "Adminium do vaší databáze nikdy nezapisuje — nastavení používá pouze metadata schématu. Doporučujeme vyhrazeného uživatele s právy pouze SELECT; kde bude mít Adminium své vlastní tabulky, rozhodnete v kroku úložiště metadat."
      }
    },
    "capability": {
    ...
    "hostedApps": {
      ...
      "instances": {
        "title": "Instance",
        "body": "Poskytujte stejnou aplikaci nad více databázemi. Každá instance je dostupná na /apps/<app>/<segment>/<strana>/ a čte jen připojení, které jí dáte.",
        "appLabel": "Aplikace",
  ...
  "studioPages": {
    ...
    "columns": {
      ...
      "addLinkedFromHelp": "Přidá počet řádků, které na jednotlivé záznamy odkazují.",
      "countBadge": "Počet",
