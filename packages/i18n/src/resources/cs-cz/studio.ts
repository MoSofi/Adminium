  ...
  "hostedApps": {
    ...
    "install": {
      ...
      "bundle": {
        ...
        "hint": "Soubor .tgz, který vytvoří `npm pack` ze sestaveného rozhraní — obsahuje manifest.json a složku staff/ nebo customer/.",
        ...
        "integrityHint": "Vložte hodnotu sha512- z `npm pack --json`, aby server ověřil právě tyto bajty. Necháte-li pole prázdné, spočítá se zde."
      },
      "database": {
