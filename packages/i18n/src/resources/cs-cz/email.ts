...
export default {
  ...
  "bookingConfirmation": {
    ...
    "subject": "Váš stůl v {venue} je rezervován",
    "preheader": "Rezervace {code} · {when} · počet osob: {party}",
    "heading": "Váš stůl je rezervován",
    "intro": "V {venue} pro vás držíme stůl. Při příchodu ukažte tento kód.",
    "codeLabel": "Kód rezervace",
    "when": "Kdy: {when}",
    "party": "Počet osob: {party}",
    "guest": "Jméno: {name}",
    "action": "Spravovat rezervaci",
    "cancel": "Online můžete zrušit nejpozději {cancelHours} h předem.",
    "footer": "{venue} · {address} · {phone}"
  },
  "signInCode": {
    "name": "Přihlašovací kód",
    "subject": "{code} je váš kód pro {appName}",
    "preheader": "Platí {minutes} minut.",
    "heading": "Váš kód",
    "intro": "Zadejte tento kód a potvrďte, že jste to vy. Platí {minutes} minut.",
    "codeLabel": "Kód",
    "notice": "Pokud jste o něj nežádali, tento e-mail ignorujte: bez kódu ho nikdo nepoužije.",
    "footer": "{appName}"
  },
  "emailChanged": {
    "name": "E-mailová adresa změněna",
    "subject": "Vaše e-mailová adresa u {appName} byla změněna",
