...
export default {
  ...
  "studioPages": {
    ...
    "columns": {
      "help": "Réordonnez les colonnes, renommez leurs en-têtes et choisissez celles qui apparaissent dans le tableau.",
      "discard": "Abandonner",
      "save": "Enregistrer les colonnes",
      "saveFailed": "Impossible d’enregistrer les colonnes",
      "pk": "Clé",
      "pii": "PII",
  ...
  "security": {
    "password": {
      "changedBody": "Utilisez le nouveau mot de passe à votre prochaine connexion. Les sessions sur vos autres appareils ne sont pas affectées — révoquez-les ci-dessous si vous voulez les déconnecter.",
