...
export default {
  ...
  "trig": {
    ...
    "forEachWhere": "où",
    "noTable": "Aucune table — une exécution par tick",
  ...
  "modal": {
    ...
    "done": "Terminé",
    "trigger": {
      "recordCreated": "Un enregistrement est créé",
      "recordUpdated": "Un enregistrement est mis à jour",
      "recordDeleted": "Un enregistrement est supprimé",
      "schedule": "Selon un calendrier"
    },
    "connection": "{connection} · {table}",
    "tablePlaceholder": "Rechercher une table…",
  ...
  "trace": {
    ...
    "skipped": "—",
    "document": {
      "ok": "document établi · {number}",
      "skipped": "aucun document établi · {reason}",
      "would": "Établirait {kind} · {name}",
      "off": "correspondance désactivée · {name}"
    }
  },
  "dur": {
    "ms": "{ms} ms",
