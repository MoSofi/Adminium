...
export default {
  ...
  "account": {
    ...
    "emailHelper": "用于登录。修改需要输入密码。",
    "confirmPassword": "当前密码",
    "confirmPasswordHelper": "在更改登录地址前，请确认是你本人。",
    "save": "保存更改",
    "saveFailed": "无法保存你的个人资料",
    "saved": "个人资料已更新",
    "savedBody": "新的信息已在整个工作区生效。如果你更改了邮箱，今后请使用新地址登录。",
    "accessTitle": "访问权限",
    "accessSubtitle": "此账户可以做什么，以及它如何证明身份。",
    "rolesHelper": "角色由管理员授予，无法在自己的账户中更改。",
    "manageTwoFactor": "管理",
    "setUpTwoFactor": "设置",
    "securityLink": "密码与会话",
    "preferences": {
  ...
  "builder": {
    ...
    "item": {
      ...
      "removed": "已移除 {name}。",
      "duplicated": "已复制 {name}。",
      "unboundHint": "此小组件在这里和线上页面上显示的都是示例数据。打开“配置”将其连接到数据表。",
      "unbound": "示例数据"
    },
    "families": {
      "kpi": "关键指标",
    ...
    "discard": "放弃更改",
    "discardTitle": "放弃你的更改？",
    "discardBody": "仪表盘将恢复到你打开编辑器时的样子。你的数据不受影响。",
    "discardConfirm": "放弃更改",
    "keepEditing": "继续编辑",
    "discarded": "更改已放弃。",
    "binding": {
      "addFilter": "添加筛选条件",
      "brokenBody": "它已不再符合此版本能够识别的查询，因此该小组件会在线上页面上显示错误。",
      "brokenTitle": "此小组件的查询已损坏",
      "bucketColumn": "日期列",
      "bucketRequired": "请选择承载日期的列。",
      "bucketUnit": "时间分组方式",
      "columnNone": "无",
      ...
      "groupByColumns": "列",
      "groupByRequired": "此视图需要一个拆分列。",
      "groupByRows": "行",
      "groupBy": "分组依据",
      "incompleteBody": "请填写高亮的字段——写了一半的查询会在线上仪表盘中失败。",
      "incompleteTitle": "此查询尚未完成",
      "limit": "最多获取的行数",
      "loadingSchema": "正在加载数据表…",
      "lossyBody": "其中的部分内容——额外的度量、排序或页面筛选联动——不会在此显示，保存后将被丢弃。",
      "lossyTitle": "此查询比本编辑器支持的更高级",
      "measureColumnRequired": "此计算需要指定一列。",
      "measureColumn": "目标列",
      "measureFn": "计算方式",
      "noConnectionBody": "只有属于某个连接的页面，其小组件才能绑定数据。",
      "noConnectionTitle": "此页面没有数据库连接",
      "noDateColumns": "此数据表没有日期或时间戳列。",
      "noFilters": "没有筛选条件——表中的每一行都会被计入。",
      "noSnapshotBody": "表和列来自该连接上次内省的结果。请在 Studio 中运行内省，然后重新打开此编辑器。",
      "noSnapshotTitle": "此连接没有架构快照",
      "op": {
        "between": "介于",
        "ilike": "包含（不区分大小写）",
        "in": "属于其中之一",
      ...
      "orderDir": "排序方向",
      "orderNone": "数据库默认顺序",
      "pickTableFirst": "请先选择数据表，才能选择其中的列。",
      "removeFilter": "移除筛选条件",
      "remove": "移除数据源",
      "save": "使用此查询",
      "sectionBreakdown": "拆分维度",
      "sectionColumns": "列",
      "sectionFilters": "筛选条件",
      "sectionMeasure": "度量",
      "sectionRows": "行",
      ...
      "sectionWindow": "时间范围",
      "selectColumns": "要显示的列",
      "selectRequired": "请至少选择一列进行显示。",
      "shape": {
        "calendarEvents": "带日期的事件",
        "categorical": "每个类别一个值",
        "distribution": "单列的分布情况",
        "matrix": "行列交叉的网格",
        "metricDelta": "一个数字，并与上一时间段对比",
        "multiTimeseries": "每个类别一条随时间变化的折线",
        "recordList": "一组行的列表",
        "record": "单行",
        "singleMetric": "单个数字",
        "stream": "最近行的实时动态",
      ...
      "summaryColumns": "{count, plural, other {# 列}}",
      "summaryFilters": "{count, plural, other {# 个筛选条件}}",
      "tableEmpty": "没有匹配的数据表。",
      "tablePlaceholder": "搜索数据表…",
      "tableRequired": "请选择要查询的数据表。",
      "table": "数据表或视图",
      "title": "数据源",
      "unbindableBody": "它展示的数据形态查询引擎尚未支持构建，因此它只会渲染自带的示例内容。",
      "unbindableTitle": "此小组件尚不能查询数据",
      "unboundBody": "它在这里和线上页面上显示的都是示例数字。请将它连接到数据表以显示真实数据。",
      "unboundTitle": "未连接到你的数据",
      "unit": {
        "day": "按天",
        "hour": "按小时",
        "month": "按月",
      ...
      "valueColumnRequired": "请选择要度量的列。",
      "valueColumn": "值列",
      "windowColumn": "日期列",
      "windowLast": "最近",
      "windowNone": "全部时间",
      "windowRequired": "与上一时间段对比需要一个日期列。",
      "windowUnit": {
        "day": "天",
        "hour": "小时",
        "month": "个月",
  ...
  "about": {
    ...
    "desktop": {
      ...
      "secret": {
        "title": "密钥存储",
        "safe": "由操作系统加密",
        "plainWarning": "此电脑没有可用的系统钥匙串，因此你的 Adminium 密钥以未加密方式存储在磁盘上。任何能读取本机文件的人都能读取它。请设置登录钥匙串（或 Linux 密钥服务）并重启 Adminium 以保护它。"
      },
      "updates": {
        "title": "更新",
        "mode": {
      ...
      "legal": {
        ...
        "viewNotices": "第三方许可证",
        "noticesTitle": "第三方声明",
        "noticesUnavailable": "第三方声明在应用打包时生成，此构建中不可用。",
        "source": "源代码",
        "close": "关闭"
      },
      "telemetry": {
        "title": "匿名使用数据",
        "label": "共享匿名使用数据",
        "description": "帮助我们决定优先支持哪些数据库引擎。除非你开启，否则默认关闭；绝不会发送架构、数据或个人信息。",
        "saveFailed": "无法保存该设置。请重试。"
      },
      "diagnostics": {
        "title": "诊断",
        "description": "有助于你报告问题的详细信息。不包含任何架构或数据。",
        "copy": "复制诊断信息",
        "copied": "已复制",
        "showLogs": "显示日志",
        "dataSize": "数据大小：{size}"
  ...
  "desktop": {
    "menu": {
      "file": "文件",
      "fileNewDatabase": "新建本地数据库…",
      "fileOpenSqlite": "打开 SQLite 文件…",
      "fileBackupNow": "立即备份…",
      "fileRestore": "从备份恢复…",
      "edit": "编辑",
      "view": "视图",
      "window": "窗口",
      "help": "帮助",
      "helpDocs": "Adminium 文档",
      "helpShortcuts": "键盘快捷键",
      "helpLogs": "显示日志",
      "helpCheckForUpdates": "检查更新…",
      "helpAbout": "关于 Adminium"
    },
    "settings": {
  ...
  "capabilities": {
    "heading": "应用权限",
    "description": "您安装的应用可以请求使用本计算机的硬件。您需逐一批准，并可随时撤销访问权限。",
    "grantedTo": "已允许 {app}",
    "status": {
      "available": "可用",
      "stub": "尚不可用",
    ...
    "catalog": {
      "printerEscpos": {
        "name": "小票打印机 (ESC/POS)",
        "scope": "在小票打印机上打印并打开连接的钱箱"
      }
    },
    "consent": {
      "title": "允许 {app}？",
      "subtitle": "{app} 请求使用本计算机的硬件。",
      "willAllow": "这将允许 {app}：",
  ...
  "audit": {
    ...
    "empty": {
      ...
      "filtered": {
        "body": "请扩大日期范围，或清除类别筛选。",
        "title": "没有符合这些筛选条件的记录"
      },
      "title": "还没有记录任何日志"
    },
    "filterActor": "操作者 ID",
    "filterCategoryAny": "任意类别",
  ...
  "security": {
    "password": {
      "changedBody": "下次登录时请使用新密码。其他设备仍保持登录——如果希望它们退出，请结束这些会话。",
      "changed": "密码已更改",
      "confirm": "确认新密码",
      "current": "当前密码",
      "failed": "无法更改你的密码",
    ...
    "sessions": {
      "expires": "{at} 过期",
      "failedBody": "这个列表是唯一能显示你的账户在哪些地方登录的地方，因此列表为空时应当视为情况未知，而不是没有任何登录。",
      "failed": "无法读取你的会话",
      "ip": "IP {ip}",
      "loading": "正在查找其他已登录的设备…",
      "noIp": "未记录 IP",
      "revokeBody": "该会话会立即结束，正在使用它的人必须重新登录。",
      "revokeFailed": "无法让该设备退出登录",
      "revokeTitle": "让此设备退出登录",
      "revoke": "退出登录",
      "seenUnknown": "最后活动：未知",
      "seen": "最后活动于 {since}",
      "thisDevice": "此设备",
      "title": "已登录的设备",
      "unknownDevice": "无法识别的设备"
    },
    "subtitle": "你的密码、你的双重验证，以及你已登录的每一处。",
    "title": "安全",
    "twoFactor": {
      "activateFailed": "该验证码未被接受",
      "activate": "开启双重验证",
      "body": "验证器应用会生成一个 6 位数字验证码，Adminium 会在你输入密码之后要求提供它。",
      "code": "验证器应用中的验证码",
      "copyKey": "复制设置密钥",
      "copyLink": "复制设置链接",
      "disableBody": "你的账户将恢复为仅使用密码，你的恢复代码也会失效。",
      "disableConfirm": "关闭",
      "disableFailed": "无法关闭双重验证",
      "disablePassword": "你的密码",
      "disableTitle": "关闭双重验证",
      "disable": "关闭双重验证",
      "enrollFailed": "无法开始设置",
      "enroll": "设置双重验证",
      ...
      "on": "已启用",
      "recovery": {
        "body": "如果你丢失了验证器，每个恢复代码可以让你登录一次。它们只在此刻显示这一次。",
        "copy": "复制恢复代码",
        "title": "保存你的恢复代码"
      },
      "reveal": "显示设置密钥",
      "secretHelper": "把设置链接粘贴到你的验证器应用中，或者手动输入密钥。",
      "secret": "设置密钥",
      "title": "双重验证"
    }
  },
  "team": {
    ...
    "counts": "活跃 {active} · 已邀请 {invited} · 已暂停 {suspended}",
    "empty": {
      "body": "邀请一位同事，让他拥有自己的登录账户和角色。",
      "filtered": {
        "body": "清除筛选条件即可查看完整名单。",
        "title": "没有符合这些筛选条件的人"
      },
    ...
    "filterRoleAny": "任意角色",
    "filterRole": "按角色筛选",
    "filterStatusAny": "任意状态",
    "filterStatus": "按状态筛选",
    "invite": {
      "copied": "已复制",
      "copyLink": "复制链接",
      "created": {
        "body": "请你自己把这个链接发送给 {email}。它只显示这一次——Adminium 只保存它的哈希值，所以一旦丢失，你就必须删除这条邀请并重新签发一条新的。",
        "title": "邀请已创建"
      },
      "emailIt": "通过邮件发送邀请",
      "expiresRelative": "该链接将于 {at}（{relative}）过期。",
      "expires": "该链接将于 {at} 过期。",
      "noEmail": {
        "smtp": "此实例未配置 SMTP 服务器，因此没有任何可用于发送邮件的途径。请通过你已经信任的渠道分享该链接。",
        "title": "Adminium 没有通过邮件发送这个链接",
        "unknown": "Adminium 无法确认此实例是否能够发送邮件。请通过你已经信任的渠道分享该链接。"
      }
    },
    "inviteButton": "邀请同事",
    "inviteDialog": {
      "description": "Adminium 会创建账户，并给你一个一次性的激活链接，由你转交给对方。",
      "emailPlaceholder": "name@example.com",
      "email": "邮箱",
      "failed": "无法创建邀请",
      "namePlaceholder": "例如：李明",
      "name": "姓名",
      "rolesHelper": "请选择能让他完成本职工作的最小权限角色。之后可以随时更改。",
      "roles": "角色",
      "submit": "创建邀请",
      "title": "邀请同事"
    },
    ...
    "noRoles": "没有角色",
    "remove": {
      "body": "此操作会抹除 {name} 的账户、他们的偏好设置和登录会话，并从他们更改过的设置记录中清空其姓名。改为暂停则会保留所有这些内容，只是不再允许他们登录。此操作无法撤销。",
      "confirm": "永久删除",
      "prompt": "输入“{email}”以确认",
      "title": "永久删除账户"
    },
    "roles": {
      "unavailable": "你的账户无法查看角色，因此这里无法分配任何角色。"
    },
    "rolesDialog": {
      "description": "用户会获得其所持有的全部角色的权限并集。",
      "failed": "无法更改角色",
      "title": "{name} 的角色"
    },
    "rolesLocked": "更改角色需要“管理角色”权限。",
    "search": "搜索姓名或邮箱",
    "status": {
      "active": "活跃",
      "invited": "已邀请",
    ...
    "subtitle": "谁在这份 Adminium 上拥有账户，以及他们各自可以做什么。",
    "title": "团队",
    "twoFactorOn": "已开启双重验证",
    "twoFactorShort": "2FA"
  },
  "email": {
    ...
    "starters": {
      "digest": {
        ...
        "heading": "这一周你的表现",
        "name": "每周摘要",
        "para1": "你的团队完成了 128 项任务，发布了 3 个版本。收入比上周增长 12% — 干得漂亮。",
        "preheader": "本周快速回顾",
        "subject": "你的一周数据 📊"
      },
      "extras": {
        ...
        "payments": "付款记录",
        "processing": "处理中",
        "quote": "{appName} 让我们的报表时间减半。",
        "quoteAuthor": "Priya R., Northwind Co",
        "refund": "退款政策",
        "refundText": "购买后 30 天内可全额退款。请联系支持发起退货。",
        "shipped": "已发货",
        "stat1": "完成任务",
        "stat2": "发布版本",
        "stat3": "收入增长",
      ...
      "failed": {
        ...
        "heading": "你的付款未成功",
        "name": "付款失败",
        "para1": "我们尝试为订单 #{orderNumber} 从你的卡中扣款，但付款失败了。为避免延误，请更新你的付款方式。",
        "para2": "我们将在 3 天后再次尝试。",
        "preheader": "更新你的付款方式",
        "subject": "需要处理：付款失败"
      },
      "feature": {
        ...
        "heading": "把琐事交给自动化",
        "name": "功能发布",
        "para1": "认识一下自动化 — 搭建“触发 → 动作”流程，让它们自动运行。欢迎新注册用户、跟进停滞的订单，并自动分派工作。",
        "preheader": "把琐事交给自动化",
        "subject": "自动化功能上线 ⚡"
      },
      "feedback": {
        ...
        "heading": "期待你的反馈",
        "name": "反馈请求",
        "para1": "你使用 {appName} 已经有一段时间了。能花两分钟告诉我们用得怎么样吗？你的回答将决定我们接下来做什么。",
        "preheader": "两分钟，一个问题",
        "subject": "我们做得怎么样，{firstName}？"
      },
      "footer": "你收到这封邮件，是因为你拥有 {appName} 账户。\n有问题？直接回复这封邮件。",
      "monthly": {
        "boxLabel": "月度收入",
        "cta": "查看完整报告",
        "heading": "你的 {month} 回顾",
        "name": "月度报告",
        "para1": "这是你在 {appName} 上这个月的故事。团队交付更多、推进更快 — 收入比上月增长 18%。",
        "para2": "深入完整明细，看看究竟是什么推动了这些数字。",
        "preheader": "你的月度回顾",
        "subject": "你的 {month} 报告已就绪 📈"
      },
      "paused": {
        "boxLabel": "数据保留",
        "boxValue": "30 天",
        ...
        "heading": "你的账户已暂停",
        "name": "账户已暂停",
        "para1": "你的账户已暂停，目前无法登录。别担心 — 你的数据是安全的，并会保留 30 天。",
        "para2": "随时可以重新激活，从上次离开的地方继续。",
        "preheader": "你的数据是安全的",
        "subject": "你的 {appName} 账户已暂停"
      },
      "receipt": {
        "attachment": "收据 PDF",
        "boxLabel": "扣款金额",
        ...
        "heading": "感谢你的订单",
        "name": "订单收据",
        "para1": "我们已收到你为订单 #{orderNumber} 支付的款项。收据副本已附上，供你存档。",
        "preheader": "感谢你的订单",
        "subject": "你在 {appName} 的收据"
      },
      "reengage": {
        "cta": "马上回来",
        "heading": "好久不见，{firstName}",
        "name": "召回邮件",
        "para1": "自你上次来过之后，变化很多。我们发布了自动化、更快的仪表盘，以及全新的报告构建器。",
        "para2": "来看看吧 — 你的账户还在原地等你。",
        "preheader": "看看有什么新变化",
        "subject": "{appName} 想念你"
      },
      "reminder": {
        "cta": "管理预约",
        "heading": "到时见，{firstName}",
        "name": "预约提醒",
        "para1": "你的预约时间是 {date} {time}。如需改期，请回复这封邮件或使用下方按钮。",
        "para2": "请提前几分钟到达。",
        "preheader": "{time} 见",
        "subject": "你的预约在 {date}"
      },
      "shipped": {
        ...
        "heading": "你的订单已发货",
        "name": "配送更新",
        "para1": "好消息，{firstName} — 订单 #{orderNumber} 已离开仓库，正在路上。点击下方按钮追踪。",
        "preheader": "追踪你的配送",
        "subject": "你的订单 #{orderNumber} 正在路上"
      },
      "verify": {
        "cta": "确认邮箱地址",
        "heading": "确认你的邮箱",
        "name": "确认邮箱",
        "para1": "感谢注册！请确认你的邮箱地址以激活 {appName} 账户。这有助于保护你的账户安全。",
        "preheader": "只需一步",
        "subject": "确认你的邮箱地址"
      },
      "welcome": {
        "cta": "打开 {appName}",
        "heading": "欢迎加入，{firstName}！",
        "name": "欢迎邮件",
        "para1": "很高兴你加入 {appName}。你的账户已准备好 — 这样开始吧。",
        "para2": "需要帮忙？随时回复这封邮件，会有真人为你解答。",
        "preheader": "我们帮你完成设置",
