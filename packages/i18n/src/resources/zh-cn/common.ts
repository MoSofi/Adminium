...
export default {
  ...
  "page": {
    "emptyLayout": {
      "title": "此页面暂无内容可显示",
      "board": "将其绑定到带有状态列的数据表，其中的行便会成为按列分组的卡片。",
      "calendar": "将其绑定到带有日期列的数据表，其中的行便会成为月视图网格上的事件。",
      "scheduler": "将其绑定到带有日期列和排班人员的数据表，其中的行便会成为时间轴上的班次。",
      "action": "打开页面设置",
      "askAdmin": "请联系管理员完成设置。"
    },
    "invalid": {
  ...
  "projectAction": {
    ...
    "menu": "操作",
    "run": "运行",
    "selected": "{count, plural, other {# 条记录}}"
  },
  "prefs": {
    "theme": {
      "label": "主题",
  ...
  "kb": {
    ...
    "article": {
      ...
      "columnRules": {
        "title": "列规则",
        "excerpt": "什么填充列、列接受什么、限制是什么——每次写入都生效，而不只是某一个表单。"
      },
      "connectDb": {
        "title": "连接你的第一个数据库",
      ...
      "createDialog": {
        "title": "“新建”与“编辑”对话框",
        "excerpt": "每个字段从何而来，以及如何自行设计而不用生成的表单。"
      },
      "docker": {
        "title": "使用 Docker 自托管",
      ...
      "install": {
        "title": "安装 Adminium",
        "excerpt": "用一条命令创建项目，或通过 docker run 或源码检出运行 Adminium。"
      },
      "lineItems": {
        "title": "明细行与预订",
        "excerpt": "带实时合计的子行表格、了解已有预订的日历，以及每个标签一条记录。"
      },
      "manifest": {
        "title": "页面清单",
      ...
      "publicApi": {
        "title": "为你的页面配置端点和密钥",
        "excerpt": "让页面或其他服务器调用你选定的表，密钥的权限限定在所选端点和方法内。"
      },
      "apiDocsPage": {
        "title": "API 文档页面",
        "excerpt": "发布 /api-docs，让调用你的 API 的人可以浏览接口并试发请求。"
      },
      "roles": {
        "title": "角色与权限",
      ...
      "tableFilters": {
        "title": "筛选表格",
        "excerpt": "六种筛选、页面自动获得的两个筛选，以及它们如何随保存的视图一起保留。"
      },
      "telemetry": {
        "title": "遥测与更新检查",
