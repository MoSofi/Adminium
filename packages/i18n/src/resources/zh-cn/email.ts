...
export default {
  ...
  "documentReady": {
    "name": "单据已就绪",
    "subject": "来自 {business} 的{kind} {number}",
    "heading": "你的{kind}已就绪",
    "body": "{business} 为你绘制了{kind} {number}，已作为附件随本邮件发送。",
    "button": "在线打开",
  ...
  "signInCode": {
    "name": "登录验证码",
    "subject": "{code} 是您的 {appName} 验证码",
    "preheader": "有效期 {minutes} 分钟。",
    "heading": "您的验证码",
    "intro": "输入此验证码以确认是您本人。有效期 {minutes} 分钟。",
    "codeLabel": "验证码",
    "notice": "如果不是您本人申请，请忽略此邮件：没有验证码，任何人都无法使用。",
    "footer": "{appName}"
  },
  "emailChanged": {
    "name": "电子邮箱已更改",
    "subject": "您在 {appName} 的电子邮箱已更改",
    "heading": "您的电子邮箱已更改",
    "intro": "{name}，您好：您在 {appName} 记录中的电子邮箱现已改为 {newEmail}。",
    "notice": "如果不是您本人操作，请立即联系我们。",
    "noticePhone": "如果不是您本人操作，请立即致电 {phone} 联系我们。",
    "footer": "{appName}"
  },
  "signInLink": {
    "name": "登录链接",
    "subject": "你的 {appName} 登录链接",
    "preheader": "仅可使用一次，有效期 {minutes} 分钟。",
    "heading": "登录 {appName}",
    "intro": "点击按钮即可登录。此链接仅可使用一次，有效期 {minutes} 分钟。",
    "action": "登录",
    "codeIntro": "在另一台设备上登录？请在那里输入此验证码。",
    "codeLabel": "验证码",
    "notice": "如果不是你本人请求的，可以忽略此邮件：没有它，任何人都无法登录。",
    "footer": "{appName}"
  }
} as const;
