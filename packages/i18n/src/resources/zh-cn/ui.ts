...
export default {
  ...
  "formDialog": {
    ...
    "issue": {
      "required": "此字段为必填项。",
      "notAllowed": "请选择列出的值之一。",
      "invalid": "此处的该值无效。",
      "invalidCharacter": "此文本包含无法保存的隐藏字符。请重新输入。",
      "email": "请输入有效的电子邮件地址。",
      "url": "请输入有效的网址。",
      "phone": "请输入有效的电话号码。",
      "number": "请输入数字。",
      ...
      "tooLong": "最多输入 {n} 个字符。",
      "tooSmall": "必须大于或等于 {min}。",
      "tooLarge": "必须小于或等于 {max}。",
      "outOfRange": "此数字超出范围。",
      "duplicate": "已添加。",
      "form": "部分值被拒绝。请检查标记的字段。"
    },
    "lines": {
      "add": "添加行",
      "remove": "移除第 {n} 行"
    ...
    "reference": {
      "noAccess": "你无权读取 {table}，因此无法在此处修改。"
    },
    "subtitle": {
      "sections": "{list}信息"
    },
  ...
  "templates": {
    "crud": {
      ...
      "emptyTitleNamed": "还没有{things}",
      "exportAction": "导出",
      "file": {
        "tooLarge": "该文件超过 {limit} 的上限。",
        "uploading": "正在上传",
        "cancel": "取消上传",
        "replace": "替换",
        "remove": "移除文件",
        ...
        "add": "添加文件",
        "removeNamed": "移除 {name}",
        "capReached": "此记录最多接受 {count, plural, other {# 个文件}}。"
      },
      "filters": {
        "chip": "{name}：{values}",
        "custom": "自定义",
      ...
      "toast": {
        ...
        "createFailed": "创建失败。",
        "created": "{entity} 已创建。",
        "createdMany": "{count, plural, other {已创建 # 条记录。}}",
        "deleteFailed": "删除失败。",
        "deleted": "{name} 已删除。",
      ...
      "linkFilter": {
        ...
        "lte": "{name} 不超过 {value}",
        "after": "{name} 晚于 {value}",
        "before": "{name} 早于 {value}",
        "onOrAfter": "{name} 在 {value} 当天或之后",
        "onOrBefore": "{name} 在 {value} 当天或之前",
        "thisMonth": "{name} 在本月",
        "lastMonth": "{name} 在上月",
        "set": "{name} 已填写",
        "unset": "{name} 为空",
        "ignoredColumn": "未按 {name} 筛选：此列表没有该列",
        "ignoredMasked": "未按 {name} 筛选：该列对你隐藏",
        "ignoredTooMany": "未按 {name} 筛选：一个链接最多带 8 个筛选",
        "ignoredValue": "未按 {name} 筛选：“{filter}”不是此列接受的筛选",
        "now": "现在",
        "daysAgo": "{count, plural, other {# 天前}}",
        "daysAhead": "{count, plural, other {# 天后}}"
      }
    },
    "queue": {
      "allSegment": "全部",
