...
export const REVIEW_STATUS: Record<TrackedLocaleId, LocaleReview> = {
  de_DE: { tracked: 3672, reviewed: 0, mt: 3628, outdated: 44, shipReady: false },
  fr_FR: { tracked: 3672, reviewed: 0, mt: 3628, outdated: 44, shipReady: false },
  cs_CZ: { tracked: 3672, reviewed: 0, mt: 3628, outdated: 44, shipReady: false },
  da_DK: { tracked: 3672, reviewed: 0, mt: 3628, outdated: 44, shipReady: false },
  zh_CN: { tracked: 3672, reviewed: 0, mt: 3628, outdated: 44, shipReady: false },
  zh_TW: { tracked: 3672, reviewed: 0, mt: 3628, outdated: 44, shipReady: false },
  ar_EG: { tracked: 3672, reviewed: 0, mt: 3628, outdated: 44, shipReady: false },
};
