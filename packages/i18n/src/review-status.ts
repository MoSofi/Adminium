...
export const REVIEW_STATUS: Record<TrackedLocaleId, LocaleReview> = {
  de_DE: { tracked: 6313, reviewed: 0, mt: 6254, outdated: 59, shipReady: false },
  fr_FR: { tracked: 6313, reviewed: 0, mt: 6254, outdated: 59, shipReady: false },
  cs_CZ: { tracked: 6313, reviewed: 0, mt: 6254, outdated: 59, shipReady: false },
  da_DK: { tracked: 6313, reviewed: 0, mt: 6254, outdated: 59, shipReady: false },
  zh_CN: { tracked: 6313, reviewed: 0, mt: 6254, outdated: 59, shipReady: false },
  zh_TW: { tracked: 6313, reviewed: 0, mt: 6254, outdated: 59, shipReady: false },
  ar_EG: { tracked: 6313, reviewed: 0, mt: 6254, outdated: 59, shipReady: false },
};
