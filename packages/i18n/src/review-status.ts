...
export const REVIEW_STATUS: Record<TrackedLocaleId, LocaleReview> = {
  de_DE: { tracked: 2783, reviewed: 0, mt: 2783, outdated: 0, shipReady: false },
  fr_FR: { tracked: 2783, reviewed: 0, mt: 2783, outdated: 0, shipReady: false },
  cs_CZ: { tracked: 2783, reviewed: 0, mt: 2783, outdated: 0, shipReady: false },
  da_DK: { tracked: 2783, reviewed: 0, mt: 2783, outdated: 0, shipReady: false },
  zh_CN: { tracked: 2783, reviewed: 0, mt: 2783, outdated: 0, shipReady: false },
  zh_TW: { tracked: 2783, reviewed: 0, mt: 2783, outdated: 0, shipReady: false },
  ar_EG: { tracked: 2783, reviewed: 0, mt: 2783, outdated: 0, shipReady: false },
};
