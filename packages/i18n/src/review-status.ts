...
export const REVIEW_STATUS: Record<TrackedLocaleId, LocaleReview> = {
  de_DE: { tracked: 6901, reviewed: 0, mt: 6838, outdated: 63, shipReady: false },
  fr_FR: { tracked: 6901, reviewed: 0, mt: 6838, outdated: 63, shipReady: false },
  cs_CZ: { tracked: 6901, reviewed: 0, mt: 6838, outdated: 63, shipReady: false },
  da_DK: { tracked: 6901, reviewed: 0, mt: 6838, outdated: 63, shipReady: false },
  zh_CN: { tracked: 6901, reviewed: 0, mt: 6838, outdated: 63, shipReady: false },
  zh_TW: { tracked: 6901, reviewed: 0, mt: 6838, outdated: 63, shipReady: false },
  ar_EG: { tracked: 6901, reviewed: 0, mt: 6838, outdated: 63, shipReady: false },
};
