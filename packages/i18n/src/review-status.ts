...
export const REVIEW_STATUS: Record<TrackedLocaleId, LocaleReview> = {
  de_DE: { tracked: 6623, reviewed: 0, mt: 6564, outdated: 59, shipReady: false },
  fr_FR: { tracked: 6623, reviewed: 0, mt: 6564, outdated: 59, shipReady: false },
  cs_CZ: { tracked: 6623, reviewed: 0, mt: 6564, outdated: 59, shipReady: false },
  da_DK: { tracked: 6623, reviewed: 0, mt: 6564, outdated: 59, shipReady: false },
  zh_CN: { tracked: 6623, reviewed: 0, mt: 6564, outdated: 59, shipReady: false },
  zh_TW: { tracked: 6623, reviewed: 0, mt: 6564, outdated: 59, shipReady: false },
  ar_EG: { tracked: 6623, reviewed: 0, mt: 6564, outdated: 59, shipReady: false },
};
