 ...
 * inside. It owns chrome (header: title, info popover, kebab menu slot,
 * drag-grip slot) and the four states, so widget components only ever render
 * the LOADED state.
 */
...
export interface WidgetFrameProps {
  /** Which of the four states to render (table). */
  ...
  /** Localized error message (never raw SQL/driver text). */
