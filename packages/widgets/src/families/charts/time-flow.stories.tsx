...
/**
 * "Time, forecast & flow" group stories: each widget's loaded variant plus the
 * four WidgetFrame states, through WidgetHost with a registry override (the
 * family barrel is green-loop-assembled). Demo payloads are the definitions'
