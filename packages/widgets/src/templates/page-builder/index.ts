...
/**
 * `page-builder` template barrel — the renderer plus the pure config/doc
 * algebra the host bindings and the engine's generator consume. Mirrors
 * `templates/page-crud/index.ts`.
 */
export {
