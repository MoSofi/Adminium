 ...
 * `chart-multiline` and `chart-bump` (research/widget-registry.md). DOM-free so
 * scheduled-report workers reuse it; identical path strings in Node and the
 * browser (acceptance #10).
 */
