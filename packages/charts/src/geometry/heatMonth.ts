...
/**
 * Pure single-month heat-grid geometry (research/widget-registry.md
 ...
 * UTC-only date math.
 *
 * RTL policy: the day-of-week columns are a horizontal categorical scale and
 * mirror under `rtl`; the week rows never move.
 */
